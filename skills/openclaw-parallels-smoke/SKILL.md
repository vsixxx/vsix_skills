...
description: Prepare, snapshot, run, rerun, debug, or interpret OpenClaw Parallels guest install, onboarding, gateway smoke, and upgrade checks across macOS, Windows, and Linux. Use when Codex needs to perform Openclaw Parallels Smoke tasks, or when the user explicitly mentions openclaw-parallels-smoke.
---
