---
name: pua-loop
description: PUA Loop — guided iterative development with recurring checks, completion evidence, and pause/abort markers. Use only when the user explicitly asks for loop/自动迭代 mode. Use when Codex needs to perform Pua Loop tasks, or when the user explicitly mentions pua-loop.
---
