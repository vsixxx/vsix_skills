...
description: 'TRL: SFT, DPO, PPO, GRPO, reward modeling for LLM RLHF. Use when Codex needs to perform Fine Tuning With Trl tasks, or when the user explicitly mentions fine-tuning-with-trl.'
---
