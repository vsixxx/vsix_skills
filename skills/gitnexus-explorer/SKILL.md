...
description: Index a codebase with GitNexus and serve an interactive knowledge graph via web UI + Cloudflare tunnel. Use when Codex needs to perform Gitnexus Explorer tasks, or when the user explicitly mentions gitnexus-explorer.
---
