...
description: 'Infographics: 21 layouts x 21 styles (信息图, 可视化). Use when Codex needs to perform Baoyu Infographic tasks, or when the user explicitly mentions baoyu-infographic.'
---
...
Adapted from [baoyu-infographic](https://github.com/JimLiu/baoyu-skills) for the current agent's tool ecosystem.
