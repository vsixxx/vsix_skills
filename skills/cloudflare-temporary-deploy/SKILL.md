...
description: Deploy a Worker live, no account, via wrangler --temporary. Use when Codex needs to perform Cloudflare Temporary Deploy tasks, or when the user explicitly mentions cloudflare-temporary-deploy.
---
