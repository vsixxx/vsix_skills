...
description: 'Use after benchmark-methodology has produced scored competitor profile cards. Assembles findings into a decision-grade report: landscape map, competitor profiles, benchmarking matrix, white-space analysis, strategic recommendations, and team alignment trigger questions. Final step in the three-skill competitive pipeline. Use when Codex needs to perform Competitive Report Structure tasks, or when the user explicitly mentions competitive-report-structure.'
---
