---
name: replicate
description: Discover, compare, and run AI models using Replicate's API. Strong fit for image, audio, and video generation pipelines that swap models frequently. Use when Codex needs to perform Replicate tasks, or when the user explicitly mentions replicate.
---
