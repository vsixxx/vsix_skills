...
description: Transform raw article text dumps in the brain into structured pages with executive summary, verbatim quotes, key insights, why-it-matters, and cross-references. Replaces walls-of-text with quotable, actionable brain pages. Use when Codex needs to perform Article Enrichment tasks, or when the user explicitly mentions article-enrichment.
---
