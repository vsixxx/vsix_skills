---
name: contact-widget
description: Self-contained floating chat widget with welcome screen, social links, meeting button, and message input. Single HTML file, zero dependencies. Use when Codex needs to perform Contact Widget tasks, or when the user explicitly mentions contact-widget.
---
