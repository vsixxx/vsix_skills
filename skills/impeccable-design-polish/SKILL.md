...
description: Follow-up design polish skill inspired by Impeccable. Use after a web or HTML artifact exists to audit, critique, polish, animate, harden, and prepare the page for a live/share pass. Use when Codex needs to perform Impeccable Design Polish tasks, or when the user explicitly mentions impeccable-design-polish.
---
