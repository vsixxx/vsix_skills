...
description: Deduplicate and synthesize raw concept stubs into a tiered intellectual map (T1 Canon to T4 Riff), tracing idea evolution across sources over time. Transforms thousands of raw concept pages into a curated intellectual fingerprint. Use when Codex needs to perform Concept Synthesis tasks, or when the user explicitly mentions concept-synthesis.
---
