...
description: 'lm-eval-harness: benchmark LLMs (MMLU, GSM8K, etc.). Use when Codex needs to perform Evaluating Llms Harness tasks, or when the user explicitly mentions evaluating-llms-harness.'
---
