...
description: 'Open Design''s weekly growth review: stars, installs, activation — the number, the driver, and the recommended move. Built as a decision-grade data & finance deck for growth & product team. Use when Codex needs to perform HTML Ppt Weekly Report tasks, or when the user explicitly mentions html-ppt-weekly-report.'
---
