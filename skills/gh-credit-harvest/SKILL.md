...
description: Harvest one community PR into a release branch with authorship and credit preserved, verified green, and a warm thank-you. Use when Codex needs to perform Gh Credit Harvest tasks, or when the user explicitly mentions gh-credit-harvest.
---
