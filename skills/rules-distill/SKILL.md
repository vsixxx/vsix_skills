---
name: rules-distill
description: Scan skills to extract cross-cutting principles and distill them into rules — append, revise, or create new rule files Use when Codex needs to perform Rules Distill tasks, or when the user explicitly mentions rules-distill.
---
