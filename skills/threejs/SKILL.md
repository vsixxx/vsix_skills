---
name: threejs
description: Three.js skills for creating 3D elements and interactive experiences in the browser — scenes, materials, controls, and post-processing. Use when Codex needs to perform Threejs tasks, or when the user explicitly mentions threejs.
---
