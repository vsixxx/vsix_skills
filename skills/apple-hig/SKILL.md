---
name: apple-hig
description: Apple Human Interface Guidelines as 14 agent skills covering platforms, foundations, components, patterns, inputs, and technologies for iOS, macOS, visionOS, watchOS, and tvOS. Use when Codex needs to perform Apple Hig tasks, or when the user explicitly mentions apple-hig.
---
