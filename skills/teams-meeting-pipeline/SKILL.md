...
description: Operate the Teams meeting summary pipeline via Hermes CLI — summarize meetings, inspect pipeline status, replay jobs, manage Microsoft Graph subscriptions. Use when Codex needs to perform Teams Meeting Pipeline tasks, or when the user explicitly mentions teams-meeting-pipeline.
---
