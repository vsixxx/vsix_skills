---
name: plan-tune
description: 'Self-tuning question sensitivity + developer psychographic for gstack (v1: observational). (gstack) Use when Codex needs to perform Plan Tune tasks, or when the user explicitly mentions plan-tune.'
---
