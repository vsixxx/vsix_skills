---
name: fal-realtime
description: Real-time and streaming AI image generation via fal.ai. Suited for moodboard exploration, draft variations, and rapid creative iteration. Use when Codex needs to perform Fal Realtime tasks, or when the user explicitly mentions fal-realtime.
---
