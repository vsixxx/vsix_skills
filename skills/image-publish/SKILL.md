---
name: image-publish
description: 当 CodexGuide 项目图片需要规范命名、右下角文字水印、阿里 OSS 上传、CDN 验证，或替换 Markdown 图片链接时使用。 Use when Codex needs to perform Image Publish tasks, or when the user explicitly mentions image-publish.
---
