...
description: Kotlin Coroutines and Flow patterns for Android and KMP — structured concurrency, Flow operators, StateFlow, error handling, and testing. Use when Codex needs to perform Kotlin Coroutines Flows tasks, or when the user explicitly mentions kotlin-coroutines-flows.
---
