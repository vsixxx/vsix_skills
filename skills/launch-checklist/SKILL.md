...
description: 'Complete launch readiness validation covering every department: code, content, store, marketing, community, infrastructure, legal, and go/no-go sign-offs. Use when Codex needs to perform Launch Checklist tasks, or when the user explicitly mentions launch-checklist.'
---
