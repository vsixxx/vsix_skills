...
description: 'A self-contained WebGL2 hero: a living oil-on-water field brightened into iridescent caustic filaments; move the cursor to bend the flow. Use when Codex needs to perform Webgl Liquid Iridescence tasks, or when the user explicitly mentions webgl-liquid-iridescence.'
---
