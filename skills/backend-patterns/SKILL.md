...
description: Backend architecture patterns, API design, database optimization, and server-side best practices for Node.js, Express, and Next.js API routes. Use when Codex needs to perform Backend Patterns tasks, or when the user explicitly mentions backend-patterns.
---
