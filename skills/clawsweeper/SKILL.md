---
name: clawsweeper
description: 'Use for all ClawSweeper work: OpenClaw issue/PR sweep reports, commit-review reports, repair jobs, cloud fix PRs, @clawsweeper maintainer mention commands, trusted ClawSweeper-reviewed autofix/automerge, GitHub Actions monitoring, permissions, gates, and manual backfills. Use when Codex needs to perform Clawsweeper tasks, or when the user explicitly mentions clawsweeper.'
---
