...
description: Locked 1920x1080 canvas deck with React component-level free composition, not bound to a fixed template. Use when Codex needs to perform Deck Open Slide Canvas tasks, or when the user explicitly mentions deck-open-slide-canvas.
---
