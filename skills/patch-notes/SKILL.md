---
name: patch-notes
description: Generate player-facing patch notes from git history, sprint data, and internal changelogs. Translates developer language into clear, engaging player communication. Use when Codex needs to perform Patch Notes tasks, or when the user explicitly mentions patch-notes.
---
