...
description: Safely track pull request feedback, resolve review comments or merge conflicts, validate fixes, and use a read-only cross-review before committing or pushing follow-up changes. Use when Codex needs to perform PR Feedback Quality Gate tasks, or when the user explicitly mentions pr-feedback-quality-gate.
---
