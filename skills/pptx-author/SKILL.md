---
name: pptx-author
description: Build PowerPoint decks headless with python-pptx. Pairs with excel-author for model-backed decks where every number traces to a workbook cell. Use for pitch decks, IC memos, earnings notes. Use when Codex needs to perform PPTX Author tasks, or when the user explicitly mentions pptx-author.
---
