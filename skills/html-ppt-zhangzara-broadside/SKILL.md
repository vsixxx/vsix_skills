...
description: Open Design's product-launch announcement and press narrative — the headline, the proof points, and the call to action. Built as a decision-grade marketing & GTM deck for press, community, prospects. Use when Codex needs to perform HTML Ppt Zhangzara Broadside tasks, or when the user explicitly mentions html-ppt-zhangzara-broadside.
---
