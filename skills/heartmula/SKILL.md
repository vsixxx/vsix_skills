---
name: heartmula
description: 'HeartMuLa: Suno-like song generation from lyrics + tags. Use when Codex needs to perform Heartmula tasks, or when the user explicitly mentions heartmula.'
---
