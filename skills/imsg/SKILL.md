---
name: imsg
description: Use the imsg CLI from OpenClaw agents for iMessage/SMS DMs, groups, replies, reactions, polls, watching, and private-API actions. Use when Codex needs to perform Imsg tasks, or when the user explicitly mentions imsg.
---
