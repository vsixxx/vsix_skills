...
description: Refactor an existing OpenClaw docs page with source-audited preservation, restructuring, and verification. Use when Codex needs to perform Openclaw Refactor Docs tasks, or when the user explicitly mentions openclaw-refactor-docs.
---
