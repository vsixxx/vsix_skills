---
name: airtable
description: Airtable REST API via curl. Records CRUD, filters, upserts. Use when Codex needs to perform Airtable tasks, or when the user explicitly mentions airtable.
---
