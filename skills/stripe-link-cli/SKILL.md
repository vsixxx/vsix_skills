...
description: Agent payments via Stripe Link — cards, SPT, approvals. Use when Codex needs to perform Stripe Link CLI tasks, or when the user explicitly mentions stripe-link-cli.
---
