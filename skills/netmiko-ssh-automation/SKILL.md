...
description: Safe Python Netmiko patterns for read-only collection, bounded batch SSH, TextFSM parsing, guarded config changes, timeouts, and network automation error handling. Use when Codex needs to perform Netmiko Ssh Automation tasks, or when the user explicitly mentions netmiko-ssh-automation.
---
