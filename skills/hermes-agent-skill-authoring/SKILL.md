...
description: 'Author in-repo SKILL.md: frontmatter, validator, structure, and writing-quality principles. Use when Codex needs to perform Hermes Agent Skill Authoring tasks, or when the user explicitly mentions hermes-agent-skill-authoring.'
---
