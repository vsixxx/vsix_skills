...
description: 'A hospital data-governance briefing: patient-data risk, the control framework, accountability, and the approval the board must give. Built as a decision-grade policy briefing deck for health-system board, regulators. Use when Codex needs to perform HTML Ppt Testing Safety Alert tasks, or when the user explicitly mentions html-ppt-testing-safety-alert.'
---
