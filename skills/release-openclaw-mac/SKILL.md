...
description: Run or recover OpenClaw macOS release signing, notarization, appcast, and asset promotion. Use when Codex needs to perform Release Openclaw Mac tasks, or when the user explicitly mentions release-openclaw-mac.
---
