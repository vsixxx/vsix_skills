...
description: Clinical Decision Support System (CDSS) development patterns. Drug interaction checking, dose validation, clinical scoring (NEWS2, qSOFA), alert severity classification, and integration into EMR workflows. Use when Codex needs to perform Healthcare Cdss Patterns tasks, or when the user explicitly mentions healthcare-cdss-patterns.
---
