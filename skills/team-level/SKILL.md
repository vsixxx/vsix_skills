---
name: team-level
description: 'Orchestrate level design team: level-designer + narrative-director + world-builder + art-director + systems-designer + qa-tester for complete area/level creation. Use when Codex needs to perform Team Level tasks, or when the user explicitly mentions team-level.'
---
