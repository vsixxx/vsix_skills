---
name: enhance-prompt
description: Improve prompts with design specs and UI/UX vocabulary. Useful for design-to-code workflows and clarifying requests for visual output. Use when Codex needs to perform Enhance Prompt tasks, or when the user explicitly mentions enhance-prompt.
---
