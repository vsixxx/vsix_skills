---
name: nano-pdf
description: Edit PDF text/typos/titles via nano-pdf CLI (NL prompts). Use when Codex needs to perform Nano PDF tasks, or when the user explicitly mentions nano-pdf.
---
