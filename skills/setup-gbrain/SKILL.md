---
name: setup-gbrain
description: 'Set up gbrain for this coding agent: install the CLI, initialize a local PGLite or Supabase brain, register MCP, capture per-remote trust policy. (gstack) Use when Codex needs to perform Setup Gbrain tasks, or when the user explicitly mentions setup-gbrain.'
---
