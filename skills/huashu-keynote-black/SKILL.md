...
description: 'Open Design''s all-hands: the year in review, the three priorities, and what every team owns next quarter. Built as a decision-grade corporate strategy deck for whole company. Use when Codex needs to perform Huashu Keynote Black tasks, or when the user explicitly mentions huashu-keynote-black.'
---
