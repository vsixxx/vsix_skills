...
description: Idiomatic C# and .NET patterns, conventions, dependency injection, async/await, and best practices for building robust, maintainable .NET applications. Use when Codex needs to perform Dotnet Patterns tasks, or when the user explicitly mentions dotnet-patterns.
---
