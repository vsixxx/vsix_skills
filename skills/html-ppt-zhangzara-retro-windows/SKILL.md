...
description: An IT security-awareness training on spotting phishing — the tells, the drill, and what to do in the first 60 seconds. Built as a decision-grade professional training deck for all employees. Use when Codex needs to perform HTML Ppt Zhangzara Retro Windows tasks, or when the user explicitly mentions html-ppt-zhangzara-retro-windows.
---
