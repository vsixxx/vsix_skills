...
If the user only asks to set up Product Design, do not continue in this skill. Use [$codexpp-product-design-user-context](../codexpp-product-design-user-context/SKILL.md).
