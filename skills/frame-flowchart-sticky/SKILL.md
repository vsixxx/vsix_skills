...
description: SVG curve connectors, sticky-note nodes, and cursor interaction with a whiteboard-brainstorm feel. Use when Codex needs to perform Frame Flowchart Sticky tasks, or when the user explicitly mentions frame-flowchart-sticky.
---
