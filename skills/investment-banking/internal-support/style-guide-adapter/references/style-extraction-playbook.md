...
- [1. Classify each source](#1-classify-each-source)
- [2. Extract visual system](#2-extract-visual-system)
  - [Colors](#colors)
  - [Typography](#typography)
  - [Layout grammar](#layout-grammar)
  - [Chart and table style](#chart-and-table-style)
- [3. Extract writing style](#3-extract-writing-style)
- [4. Identify rules versus quirks](#4-identify-rules-versus-quirks)
- [5. Build a style profile](#5-build-a-style-profile)
- [6. Office metadata extraction](#6-office-metadata-extraction)
...
For Office files, use [`scripts/extract_office_style.py`](../scripts/extract_office_style.py) when available to extract theme fonts, theme colors, named styles, slide layout names, workbook sheet names, and style metadata. Treat this as a supplement, not a substitute for visual review.
