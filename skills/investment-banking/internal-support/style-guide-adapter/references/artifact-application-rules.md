...
Use this guide when applying a style profile to a real artifact. Preserve the artifact's substance unless the user explicitly requests rewriting, restructuring, or content deletion.
