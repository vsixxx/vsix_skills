---
name: mysql-patterns
description: MySQL and MariaDB schema, query, indexing, transaction, replication, and connection-pool patterns for production backends. Use when Codex needs to perform Mysql Patterns tasks, or when the user explicitly mentions mysql-patterns.
---
