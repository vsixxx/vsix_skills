---
name: weather
description: Current weather and forecasts with web_fetch, falling back to wttr.in curl for locations, rain, temperature, travel planning. Use when Codex needs to perform Weather tasks, or when the user explicitly mentions weather.
---
