...
description: NestJS architecture patterns for modules, controllers, providers, DTO validation, guards, interceptors, config, and production-grade TypeScript backends. Use when Codex needs to perform Nestjs Patterns tasks, or when the user explicitly mentions nestjs-patterns.
---
