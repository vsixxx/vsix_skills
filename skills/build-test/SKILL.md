---
name: build-test
description: Run the project's build / typecheck / lint / test commands and emit the build.passing + tests.passing signals devloop convergence reads. Use when Codex needs to perform Build Test tasks, or when the user explicitly mentions build-test.
---
