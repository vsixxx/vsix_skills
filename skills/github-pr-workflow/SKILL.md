...
description: 'GitHub PR lifecycle: branch, commit, open, CI, merge. Use when Codex needs to perform GitHub PR Workflow tasks, or when the user explicitly mentions github-pr-workflow.'
---
