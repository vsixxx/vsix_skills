...
description: Uses Chrome DevTools MCP and documentation to troubleshoot connection and target issues. Trigger this skill when list_pages, new_page, or navigate_page fail, or when the server initialization fails. Use when Codex needs to perform Troubleshooting tasks, or when the user explicitly mentions troubleshooting.
---
