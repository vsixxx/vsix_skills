---
name: verify-release
description: Verify an OpenClaw release is fully published across GitHub, npm, plugins, ClawHub, package smoke, and live Gateway agent turns. Use when Codex needs to perform Verify Release tasks, or when the user explicitly mentions verify-release.
---
