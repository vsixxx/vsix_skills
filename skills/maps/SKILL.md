---
name: maps
description: Geocode, POIs, routes, timezones via OpenStreetMap/OSRM. Use when Codex needs to perform Maps tasks, or when the user explicitly mentions maps.
---
...
Script path: `$CODEX_HOME/skills/maps/scripts/maps_client.py`

## Commands

```bash
MAPS=$CODEX_HOME/skills/maps/scripts/maps_client.py
```
...
```bash
python3 $CODEX_HOME/skills/maps/scripts/maps_client.py search "Statue of Liberty"
# Should return lat ~40.689, lon ~-74.044

python3 $CODEX_HOME/skills/maps/scripts/maps_client.py nearby --near "Times Square" --category restaurant --limit 3
