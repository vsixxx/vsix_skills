---
name: model-usage
description: Summarize CodexBar local cost logs by model for Codex or Claude, including current or full breakdowns. Use when Codex needs to perform Model Usage tasks, or when the user explicitly mentions model-usage.
---
