...
- Refer to the Plugin router [$codexpp-product-design-index](../codexpp-product-design-index/SKILL.md) before proceeding.
- Follow [$critical-overrides](plugin-support/references/critical-overrides.md).

## User Context

Before starting, load [$codexpp-product-design-user-context](../codexpp-product-design-user-context/SKILL.md) and run its preflight script when local shell access is available.
...
8. Build the app starting with [local-prototype-preflight](plugin-support/references/local-prototype-preflight.md). Build all interactions, ensuring the app is complete, functional, and interactive: all controls and states activated and functional.
...
10. Capture the local app using [browser-order](plugin-support/references/browser-order.md).
...
12. Handoff the app or website.
    ...
    - Include the post-build iteration and share nudge from [critical-overrides](plugin-support/references/critical-overrides.md#build-handoff).
