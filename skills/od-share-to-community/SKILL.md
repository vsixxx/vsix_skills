...
description: Package the user's just-finished work as an Open Design plugin without asking for fields the project files already answer, then surface the existing Add-to-My-plugins / Open-Design-PR buttons. Use when Codex needs to perform Od Share To Community tasks, or when the user explicitly mentions od-share-to-community.
---
