...
description: Generate ideas via named methods from creative practice. Use when Codex needs to perform Creative Ideation tasks, or when the user explicitly mentions creative-ideation.
---

# Creative Ideation — Routed Library of Creative Methods
