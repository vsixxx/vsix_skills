...
description: Choose, run, rerun, or debug OpenClaw tests, CI checks, Docker E2E lanes, release validation, and the cheapest safe verification path. Use when Codex needs to perform Openclaw Testing tasks, or when the user explicitly mentions openclaw-testing.
---
