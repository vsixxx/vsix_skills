...
description: 'Open-source pipeline: fork, sanitize, and package private projects for safe public release. Chains 3 agents (forker, sanitizer, packager). Triggers: ''/opensource'', ''open source this'', ''make this public'', ''prepare for open source''. Use when Codex needs to perform Opensource Pipeline tasks, or when the user explicitly mentions opensource-pipeline.'
---
