---
name: fal-train
description: Train custom AI models (LoRA) on fal.ai for personalized image generation tailored to a brand, character, or style. Use when Codex needs to perform Fal Train tasks, or when the user explicitly mentions fal-train.
---
