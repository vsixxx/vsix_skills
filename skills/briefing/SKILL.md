---
name: briefing
description: Compile daily briefing with meeting context, active deals, and citation tracking Use when Codex needs to perform Briefing tasks, or when the user explicitly mentions briefing.
---
