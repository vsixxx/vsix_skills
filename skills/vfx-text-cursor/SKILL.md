...
description: Cursor light trail, chromatic rays, and directional flares for word-by-word quote reveals in video intros. Use when Codex needs to perform Vfx Text Cursor tasks, or when the user explicitly mentions vfx-text-cursor.
---
