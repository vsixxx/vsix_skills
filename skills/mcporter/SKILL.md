---
name: mcporter
description: Use the mcporter CLI to list, configure, auth, and call MCP servers/tools directly (HTTP or stdio), including ad-hoc servers, config edits, and CLI/type generation. Use when Codex needs to perform Mcporter tasks, or when the user explicitly mentions mcporter.
---
...
# Machine-readable output (recommended for agent use)
