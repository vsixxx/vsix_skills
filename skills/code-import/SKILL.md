---
name: code-import
description: Read an existing repository's structure into the project cwd as a normalised snapshot the agent can analyse without re-walking the tree on every turn. Use when Codex needs to perform Code Import tasks, or when the user explicitly mentions code-import.
---
