---
name: update-version
description: Update `AvailableFrom` in a PR to the next Remotion patch version (`main` + `0.0.1`). Use when Codex needs to perform Update Version tasks, or when the user explicitly mentions update-version.
---
