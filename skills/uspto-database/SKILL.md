---
name: uspto-database
description: USPTO patent and trademark data workflow for official record lookup, PatentSearch queries, TSDR checks, assignment data, and reproducible IP research logs. Use when Codex needs to perform Uspto Database tasks, or when the user explicitly mentions uspto-database.
---
