---
name: coding-agent
description: Delegate coding work to Codex, Claude Code, or OpenCode as background workers; not simple edits or read-only code lookup. Use when Codex needs to perform Coding Agent tasks, or when the user explicitly mentions coding-agent.
---
