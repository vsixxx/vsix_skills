---
name: team-builder
description: Interactive agent picker for composing and dispatching parallel teams Use when Codex needs to perform Team Builder tasks, or when the user explicitly mentions team-builder.
---
