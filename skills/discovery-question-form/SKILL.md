...
description: Turn-1 discovery question form for ambiguous briefs. Use when Codex needs to perform Discovery Question Form tasks, or when the user explicitly mentions discovery-question-form.
---
