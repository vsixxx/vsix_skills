---
name: open-design-minimax-pdf
description: Generate, fill, and reformat PDFs with a token-based design system and 15 cover styles. Useful for branded PDFs, e-guides, and reports. Use when Codex needs to perform Open Design Minimax PDF tasks, or when the user explicitly mentions open-design-minimax-pdf.
---
