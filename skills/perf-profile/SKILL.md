---
name: perf-profile
description: Structured performance profiling workflow. Identifies bottlenecks, measures against budgets, and generates optimization recommendations with priority rankings. Use when Codex needs to perform Perf Profile tasks, or when the user explicitly mentions perf-profile.
---
