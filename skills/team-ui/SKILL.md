---
name: team-ui
description: 'Orchestrate the UI team through the full UX pipeline: from UX spec authoring through visual design, implementation, review, and polish. Integrates with /ux-design, /ux-review, and studio UX templates. Use when Codex needs to perform Team Ui tasks, or when the user explicitly mentions team-ui.'
---
