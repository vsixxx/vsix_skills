...
description: A review deck on compositional generalization in large language models — the field map, the gap, the evidence, and open questions. Built as a decision-grade academic research deck for PI, lab group, reviewers. Use when Codex needs to perform Hps Academic Paper tasks, or when the user explicitly mentions hps-academic-paper.
---
