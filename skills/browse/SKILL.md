---
name: browse
description: Fast headless browser for QA testing and site dogfooding. (gstack) Use when Codex needs to perform Browse tasks, or when the user explicitly mentions browse.
---
