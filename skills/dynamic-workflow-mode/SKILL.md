...
description: Design task-local harnesses, eval gates, and reusable skill extraction for Claude dynamic workflow mode and other adaptive agent harnesses. Use when Codex needs to perform Dynamic Workflow Mode tasks, or when the user explicitly mentions dynamic-workflow-mode.
---
