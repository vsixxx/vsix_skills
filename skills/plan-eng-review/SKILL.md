...
description: Eng manager-mode plan review. (gstack) Use when Codex needs to perform Plan Eng Review tasks, or when the user explicitly mentions plan-eng-review.
---
