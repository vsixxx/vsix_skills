...
description: Structured scholarly-work evaluation for papers, proposals, literature reviews, methods sections, evidence quality, citation support, and research-writing feedback. Use when Codex needs to perform Scholar Evaluation tasks, or when the user explicitly mentions scholar-evaluation.
---
