...
|---|---|---|
| critical | likely to change decision, valuation, financing terms, recommendation, or client trust | wrong EBITDA in valuation summary; IRR conflicts with model; covenant headroom overstated; source contradicts thesis |
...
Claim relies on estimates, seller/management materials, unaudited figures, non-GAAP data, assumptions, or preliminary numbers without labeling.
