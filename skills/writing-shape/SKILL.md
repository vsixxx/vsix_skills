---
name: writing-shape
description: Writing, exploit — shape raw material into an article, paragraph by paragraph. Use when Codex needs to perform Writing Shape tasks, or when the user explicitly mentions writing-shape.
---
