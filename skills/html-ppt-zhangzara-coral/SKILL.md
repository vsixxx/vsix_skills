...
description: 'Open Design''s community-growth campaign across GitHub, Discord, and X: the loops, the content calendar, and the pipeline math. Built as a decision-grade marketing & GTM deck for growth team, community lead. Use when Codex needs to perform HTML Ppt Zhangzara Coral tasks, or when the user explicitly mentions html-ppt-zhangzara-coral.'
---
