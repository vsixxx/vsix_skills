---
name: asset-spec
description: Generate per-asset visual specifications and AI generation prompts from GDDs, level docs, or character profiles. Produces structured spec files and updates the master asset manifest. Run after art bible and GDD/level design are approved, before production begins. Use when Codex needs to perform Asset Spec tasks, or when the user explicitly mentions asset-spec.
---
