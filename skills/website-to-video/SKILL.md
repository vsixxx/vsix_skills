...
description: Capture a general website/URL and turn it into a video OF the site — tour, showcase, or social clip built from captured screenshots and the site's own brand assets. Use for portfolio / blog / docs / landing-page showcases. Not a product launch or promo, even from a URL (/product-launch-video). Unclear → /hyperframes. Use when Codex needs to perform Website To Video tasks, or when the user explicitly mentions website-to-video.
---
