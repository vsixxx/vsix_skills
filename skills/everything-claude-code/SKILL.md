...
description: Development conventions and patterns for everything-claude-code. JavaScript project with conventional commits. Use when Codex needs to perform Everything Claude Code tasks, or when the user explicitly mentions everything-claude-code.
---
