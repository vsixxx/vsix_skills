...
description: Fix only small, high-certainty OpenClaw bugs from a pasted issue/PR list after deep code review. Use when Codex needs to perform Openclaw Small Bugfix Sweep tasks, or when the user explicitly mentions openclaw-small-bugfix-sweep.
---
