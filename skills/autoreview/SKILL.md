---
name: autoreview
description: 'Pre-commit/ship code review: Codex default; optional Claude or Pi. Use when Codex needs to perform Autoreview tasks, or when the user explicitly mentions autoreview.'
---
