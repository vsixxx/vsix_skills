---
name: spec
description: Turn vague intent into a precise, executable spec in five phases. (gstack) Use when Codex needs to perform Spec tasks, or when the user explicitly mentions spec.
---
