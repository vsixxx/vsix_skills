...
description: Kubernetes workload patterns, resource management, RBAC, probes, autoscaling, ConfigMap/Secret handling, and kubectl debugging for production-grade deployments. Use when Codex needs to perform Kubernetes Patterns tasks, or when the user explicitly mentions kubernetes-patterns.
---
