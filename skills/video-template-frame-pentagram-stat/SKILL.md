...
description: Use this plugin when the user wants a "Pentagram Stat Frame" HyperFrames motion video — Swiss-grid statistic anchor — giant number, red accent, growing bars, black data bar. Rational and editorial. Use when Codex needs to perform Video Template Frame Pentagram Stat tasks, or when the user explicitly mentions video-template-frame-pentagram-stat.
---
