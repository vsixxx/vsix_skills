---
name: django-tdd
description: Django testing strategies with pytest-django, TDD methodology, factory_boy, mocking, coverage, and testing Django REST Framework APIs. Use when Codex needs to perform Django Tdd tasks, or when the user explicitly mentions django-tdd.
---
