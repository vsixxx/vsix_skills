...
description: Gmail, Calendar, Drive, Docs, Sheets via gws CLI or Python. Use when Codex needs to perform Google Workspace tasks, or when the user explicitly mentions google-workspace.
---
