---
name: waitlist-page
description: 'Minimal pre-launch landing with email capture, brand logo, and optional decorative layer. Reads DESIGN.md for colors, typography, and layout rules. Best for: product launches, beta signups, early access programs, indie projects. Use when Codex needs to perform Waitlist Page tasks, or when the user explicitly mentions waitlist-page.'
---
