---
name: shader-dev
description: Comprehensive GLSL shader techniques for creating stunning visual effects — ray marching, SDF modeling, fluid simulation, particle systems, procedural generation, lighting, post-processing, and more. Use when Codex needs to perform Shader Dev tasks, or when the user explicitly mentions shader-dev.
---
