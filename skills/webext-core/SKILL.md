---
name: webext-core
description: Utilities for browser extensions - proxy services for cross-context RPC, type-safe messaging, URL match patterns, fake browser for testing, job scheduling, and shadow DOM isolation. Use when Codex needs to perform Webext Core tasks, or when the user explicitly mentions webext-core.
---
