...
description: A workplace-safety compliance review for a manufacturing regulator — findings, the evidence chain, and the corrective mandate. Built as a decision-grade policy briefing deck for regulator, plant leadership. Use when Codex needs to perform HTML Ppt Zhangzara Stencil Tablet tasks, or when the user explicitly mentions html-ppt-zhangzara-stencil-tablet.
---
