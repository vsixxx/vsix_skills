---
name: openhands
description: Delegate coding to OpenHands CLI (model-agnostic, LiteLLM). Use when Codex needs to perform Openhands tasks, or when the user explicitly mentions openhands.
---
