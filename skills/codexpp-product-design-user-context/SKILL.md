---
name: codexpp-product-design-user-context
...
If `codexpp-product-design-user-context.md` exists, use it by default.
...
```text
$CODEX_HOME/state/plugins/product-design/codexpp-product-design-user-context.md
```
...
Then add the references to the created `codexpp-product-design-user-context.md`.
...
When the user provides screenshots or reference images to save, copy them into `assets/` next to `codexpp-product-design-user-context.md` and link them from the saved entry.
