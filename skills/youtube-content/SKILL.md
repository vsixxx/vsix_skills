...
description: YouTube transcripts to summaries, threads, blogs. Use when Codex needs to perform YouTube Content tasks, or when the user explicitly mentions youtube-content.
---
...
Use `uv` so the dependency is installed into the same the current agent-managed environment
