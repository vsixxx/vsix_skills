---
name: landing-report
description: Read-only queue dashboard for workspace-aware ship. (gstack) Use when Codex needs to perform Landing Report tasks, or when the user explicitly mentions landing-report.
---
