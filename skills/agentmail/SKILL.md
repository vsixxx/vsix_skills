---
name: agentmail
description: Give the agent its own dedicated email inbox via AgentMail. Send, receive, and manage email autonomously using agent-owned email addresses (e.g. hermes-agent@agentmail.to). Use when Codex needs to perform Agentmail tasks, or when the user explicitly mentions agentmail.
---
