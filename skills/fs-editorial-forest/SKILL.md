...
description: Art-directing a fashion house's annual report — the editorial system, the photography rhythm, and the data spreads. Built as a decision-grade design craft deck for brand stakeholders, exec audience. Use when Codex needs to perform Fs Editorial Forest tasks, or when the user explicitly mentions fs-editorial-forest.
---
