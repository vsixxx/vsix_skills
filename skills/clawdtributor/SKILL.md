---
name: clawdtributor
description: 'Use for OpenClaw clawtributors PR/issue triage: Discrawl discovery, live-open rechecks, deep review, topic grouping, and compact @handle/LOC/type/blast/verification summaries. Use when Codex needs to perform Clawdtributor tasks, or when the user explicitly mentions clawdtributor.'
---
