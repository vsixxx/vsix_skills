---
name: searxng-search
description: Free meta-search via SearXNG — aggregates results from 70+ search engines. Self-hosted or use a public instance. No API key needed. Falls back automatically when the web search toolset is unavailable. Use when Codex needs to perform Searxng Search tasks, or when the user explicitly mentions searxng-search.
---
