...
description: Add a test case to the web renderer Use when Codex needs to perform Web Renderer Test tasks, or when the user explicitly mentions web-renderer-test.
---
