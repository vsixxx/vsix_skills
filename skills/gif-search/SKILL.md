---
name: gif-search
description: Search/download GIFs from Tenor via curl + jq. Use when Codex needs to perform Gif Search tasks, or when the user explicitly mentions gif-search.
---
