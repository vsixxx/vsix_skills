...
description: Release notes one-page HTML with highlights, Added, Fixed, Breaking changes, Known issues, and Upgrade note. Writes explicit "None" style sections whenever the user does not provide details. Use when Codex needs to perform Release Notes One Pager tasks, or when the user explicitly mentions release-notes-one-pager.
---
