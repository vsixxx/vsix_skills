...
description: A pixel-faithful, self-contained mirror of the live open-design.ai homepage — an interactive React Three Fiber / Next.js hero with a real-time 3D wordmark, sticker collage, variable fonts, and scroll-driven motion. First-party showcase of the visual ceiling for interactive web marketing surfaces. Use when Codex needs to perform Open Design Homepage tasks, or when the user explicitly mentions open-design-homepage.
---
