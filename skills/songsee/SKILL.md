---
name: songsee
description: Audio spectrograms/features (mel, chroma, MFCC) via CLI. Use when Codex needs to perform Songsee tasks, or when the user explicitly mentions songsee.
---
