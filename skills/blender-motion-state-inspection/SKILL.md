...
description: Use this skill when inspecting Blender characters, rigs, poses, animation retargeting, ground contact, facing direction, or model-vs-motion alignment where screenshots alone are not enough. Use when Codex needs to perform Blender Motion State Inspection tasks, or when the user explicitly mentions blender-motion-state-inspection.
---
