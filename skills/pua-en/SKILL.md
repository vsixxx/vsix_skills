---
name: pua-en
description: Performance-coaching mode for repeated failures, passive behavior, completion-quality issues, or explicit try-harder requests. Uses structured troubleshooting and evidence-first delivery habits. Use when Codex needs to perform Pua En tasks, or when the user explicitly mentions pua-en.
---
