...
description: Add a redacted agent transcript section to GitHub PR or issue bodies during OpenClaw agent-created PR/issue workflows. Use when Codex needs to perform Agent Transcript tasks, or when the user explicitly mentions agent-transcript.
---
