---
name: fal-upscale
description: Upscale and enhance image and video resolution using AI super-resolution models hosted on fal.ai. Use when Codex needs to perform Fal Upscale tasks, or when the user explicitly mentions fal-upscale.
---
