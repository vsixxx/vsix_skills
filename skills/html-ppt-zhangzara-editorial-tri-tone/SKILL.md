...
description: A type-and-color system for a culture magazine relaunch — the grid, the tri-tone palette, and the layout kit. Built as a decision-grade design craft deck for editorial & design team. Use when Codex needs to perform HTML Ppt Zhangzara Editorial Tri Tone tasks, or when the user explicitly mentions html-ppt-zhangzara-editorial-tri-tone.
---
