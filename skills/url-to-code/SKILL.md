...
2. Open the source URL using [browser-order](plugin-support/references/browser-order.md).
...
8. Create the local app with [local-prototype-preflight](plugin-support/references/local-prototype-preflight.md).
