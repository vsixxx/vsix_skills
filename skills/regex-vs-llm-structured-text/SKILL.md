...
description: Decision framework for choosing between regex and LLM when parsing structured text — start with regex, add LLM only for low-confidence edge cases. Use when Codex needs to perform Regex Vs LLM Structured Text tasks, or when the user explicitly mentions regex-vs-llm-structured-text.
---
