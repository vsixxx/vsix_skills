...
description: Use this plugin when the user wants a "Play Mode" HyperFrames motion video — Playful elastic animations Use when Codex needs to perform Video Template Frame Play Mode tasks, or when the user explicitly mentions video-template-frame-play-mode.
---
