...
description: Build MCP servers with Node/TypeScript SDK — tools, resources, prompts, Zod validation, stdio vs Streamable HTTP. Use Context7 or official MCP docs for latest API. Use when Codex needs to perform MCP Server Patterns tasks, or when the user explicitly mentions mcp-server-patterns.
---
