---
name: brain-ops
description: 'Brain knowledge base operations. The core read/write cycle: brain-first lookup, read-enrich-write loop, source attribution, ambient enrichment, back-linking. Read this before any brain interaction. Use when Codex needs to perform Brain Ops tasks, or when the user explicitly mentions brain-ops.'
---
