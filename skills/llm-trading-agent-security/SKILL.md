...
description: Security patterns for autonomous trading agents with wallet or transaction authority. Covers prompt injection, spend limits, pre-send simulation, circuit breakers, MEV protection, and key handling. Use when Codex needs to perform LLM Trading Agent Security tasks, or when the user explicitly mentions llm-trading-agent-security.
---
