---
name: openclaw-xurl
description: xurl CLI for authenticated X posts, replies, reads/search, DMs, media upload, followers, auth status, or raw v2 API calls. Use when Codex needs to perform Openclaw Xurl tasks, or when the user explicitly mentions openclaw-xurl.
---
