---
name: llm-wiki
description: 'Karpathy''s LLM Wiki: build/query interlinked markdown KB. Use when Codex needs to perform LLM Wiki tasks, or when the user explicitly mentions llm-wiki.'
---
