...
description: 'Open Design''s financial review: runway, burn, and the sustainability plan that keeps the project independent. Built as a decision-grade data & finance deck for board, leadership. Use when Codex needs to perform Ve Midnight Editorial tasks, or when the user explicitly mentions ve-midnight-editorial.'
---
