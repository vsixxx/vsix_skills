...
description: Restore working context saved earlier by /context-save. (gstack) Use when Codex needs to perform Context Restore tasks, or when the user explicitly mentions context-restore.
---
