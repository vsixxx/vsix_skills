---
name: writing-beats
description: Writing, exploit — assemble raw material into a journey of beats, grounding each term before a beat leans on it. Use when Codex needs to perform Writing Beats tasks, or when the user explicitly mentions writing-beats.
---
