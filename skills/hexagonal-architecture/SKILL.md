...
description: Design, implement, and refactor Ports & Adapters systems with clear domain boundaries, dependency inversion, and testable use-case orchestration across TypeScript, Java, Kotlin, and Go services. Use when Codex needs to perform Hexagonal Architecture tasks, or when the user explicitly mentions hexagonal-architecture.
---
