...
description: A brand-repositioning strategy for a heritage coffee chain — why, how, what — the governing idea and the moves to prove it. Built as a decision-grade consulting deck for client CMO, board. Use when Codex needs to perform Huashu Golden Circle tasks, or when the user explicitly mentions huashu-golden-circle.
---
