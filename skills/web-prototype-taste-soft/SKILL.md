...
description: Apple-tier soft web prototype. Silver/cream canvas, double-bezel cards, button-in-button CTAs, generous squircle radii, spring motion, ambient mesh. Distilled from Leonxlnx/taste-skill `soft-skill` + sections 4–8 of `taste-skill`. Use when Codex needs to perform Web Prototype Taste Soft tasks, or when the user explicitly mentions web-prototype-taste-soft.
---
