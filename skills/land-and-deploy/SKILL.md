...
description: Land and deploy workflow. (gstack) Use when Codex needs to perform Land And Deploy tasks, or when the user explicitly mentions land-and-deploy.
---
