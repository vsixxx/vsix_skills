...
description: 'Work with Obsidian vaults using the official obsidian CLI: read/search/create/edit notes, tasks, links, properties, plugins. Use when Codex needs to perform Openclaw Obsidian tasks, or when the user explicitly mentions openclaw-obsidian.'
---
