...
- For a selected HTML tearsheet, follow `../../plugin-support/shared/html-artifact-standard.md` and keep the issuer baseline compact rather than forcing the standardized dashboard shell.
