...
When the user requests HTML or selects it during intake, produce a polished standalone HTML tearsheet following `../../plugin-support/shared/html-artifact-standard.md`. Keep it a compact issuer baseline rather than a dashboard shell or initiation report.
