...
description: WebGL-style fluid displacement background with a quote overlay, suited to video intros, landing heroes, or posters. Use when Codex needs to perform Frame Liquid Bg Hero tasks, or when the user explicitly mentions frame-liquid-bg-hero.
---
