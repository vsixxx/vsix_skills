---
name: cpp-testing
description: Use only when writing/updating/fixing C++ tests, configuring GoogleTest/CTest, diagnosing failing or flaky tests, or adding coverage/sanitizers. Use when Codex needs to perform Cpp Testing tasks, or when the user explicitly mentions cpp-testing.
---
