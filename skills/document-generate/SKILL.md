...
description: Generate missing documentation from scratch for a feature, module, or entire project. (gstack) Use when Codex needs to perform Document Generate tasks, or when the user explicitly mentions document-generate.
---
