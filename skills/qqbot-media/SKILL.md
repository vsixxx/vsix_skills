---
name: qqbot-media
description: QQBot rich media send and receive support. Use [qqmedia] tags only for explicit media send/view requests, treating inbound attachment paths as private current-conversation context. Use when Codex needs to perform Qqbot Media tasks, or when the user explicitly mentions qqbot-media.
---
