---
name: huashu-slides
description: A career-pivot story from consultant to product leader — the arc, the proof, and why the next role is the right bet. Built as a decision-grade career deck for hiring manager, mentors. Use when Codex needs to perform Huashu Slides tasks, or when the user explicitly mentions huashu-slides.
---
