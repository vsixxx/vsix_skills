---
name: prose
description: OpenProse VM skill pack. Activate on any `prose` command, .prose files, or OpenProse mentions; orchestrates multi-agent workflows. Use when Codex needs to perform Prose tasks, or when the user explicitly mentions prose.
---
