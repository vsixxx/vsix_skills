---
name: dspy
description: 'DSPy: declarative LM programs, auto-optimize prompts, RAG. Use when Codex needs to perform Dspy tasks, or when the user explicitly mentions dspy.'
---
