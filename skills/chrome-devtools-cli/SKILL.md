...
description: Use this skill to write shell scripts or run shell commands to automate tasks in the browser or otherwise use Chrome DevTools via CLI. Use when Codex needs to perform Chrome Devtools CLI tasks, or when the user explicitly mentions chrome-devtools-cli.
---
