---
name: apple-notes
description: 'Manage Apple Notes via memo CLI: create, search, edit. Use when Codex needs to perform Apple Notes tasks, or when the user explicitly mentions apple-notes.'
---
