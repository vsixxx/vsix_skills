---
name: kotlin-testing
description: Kotlin testing patterns with Kotest, MockK, coroutine testing, property-based testing, and Kover coverage. Follows TDD methodology with idiomatic Kotlin practices. Use when Codex needs to perform Kotlin Testing tasks, or when the user explicitly mentions kotlin-testing.
---
