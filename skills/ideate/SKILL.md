...
Follow the shared Product Design routing guidance in [$codexpp-product-design-index](../codexpp-product-design-index/SKILL.md).
...
- Check likely design context folders such as `codexpp-product-design-user-context`, `storybook/`, `.storybook/`, `design-system/`, `design-systems/`, `tokens/`, `components/`, `app/`, and generated prototype roots.
