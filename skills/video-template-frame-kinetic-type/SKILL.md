---
name: video-template-frame-kinetic-type
description: Use this plugin when the user wants a "Kinetic Type" HyperFrames motion video — Bold kinetic typography promo Use when Codex needs to perform Video Template Frame Kinetic Type tasks, or when the user explicitly mentions video-template-frame-kinetic-type.
---
...
**Best for:** Promo headline · Bold statement · Punchy intro
...
Source: html-video `templates/frame-kinetic-type` (license Apache-2.0). Forked from heygen-com / Hyperframes — https://github.com/heygen-com/hyperframes/tree/main/registry/examples/kinetic-type.
