---
name: tavily
description: Tavily web search, content extraction, and research tools. Use when Codex needs to perform Tavily tasks, or when the user explicitly mentions tavily.
---
