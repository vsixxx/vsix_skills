...
description: Triage OpenClaw security advisories, drafts, and GHSA reports with shipped-tag and trust-model proof. Use when Codex needs to perform Security Triage tasks, or when the user explicitly mentions security-triage.
---
