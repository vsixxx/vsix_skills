---
name: perl-patterns
description: Modern Perl 5.36+ idioms, best practices, and conventions for building robust, maintainable Perl applications. Use when Codex needs to perform Perl Patterns tasks, or when the user explicitly mentions perl-patterns.
---
