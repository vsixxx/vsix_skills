...
description: 'Open Design internals: how the agent stream, sandbox, and artifacts work — an engineering deep-dive talk. Built as a decision-grade AI literacy deck for engineers, dev community. Use when Codex needs to perform HTML Ppt Tech Sharing tasks, or when the user explicitly mentions html-ppt-tech-sharing.'
---
