...
description: Debug Node.js with node inspect, --inspect, breakpoints, CDP, heap, and CPU profiles. Use when Codex needs to perform Openclaw Node Inspect Debugger tasks, or when the user explicitly mentions openclaw-node-inspect-debugger.
---

# Openclaw Node Inspect Debugger
