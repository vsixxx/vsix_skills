---
name: sprint-plan
description: Generates a new sprint plan or updates an existing one based on the current milestone, completed work, and available capacity. Pulls context from production documents and design backlogs. Use when Codex needs to perform Sprint Plan tasks, or when the user explicitly mentions sprint-plan.
---
