...
description: 'A personal manifesto: a year of saying yes — the premise, the scenes, the turn, and the meaning that lands. Built as a decision-grade story deck for community, talk audience. Use when Codex needs to perform HTML Ppt Xhs Pastel Card tasks, or when the user explicitly mentions html-ppt-xhs-pastel-card.'
---
