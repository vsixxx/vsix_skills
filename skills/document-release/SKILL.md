...
description: Post-ship documentation update. (gstack) Use when Codex needs to perform Document Release tasks, or when the user explicitly mentions document-release.
---
