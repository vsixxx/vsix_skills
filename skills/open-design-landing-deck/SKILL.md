...
description: 'Open Design''s brand-story deck for partners and press: why it exists, what it believes, and where design is going. Built as a decision-grade marketing & GTM deck for partners, press, community. Use when Codex needs to perform Open Design Landing Deck tasks, or when the user explicitly mentions open-design-landing-deck.'
---
