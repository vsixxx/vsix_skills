---
name: fsharp-testing
description: F# testing patterns with xUnit, FsUnit, Unquote, FsCheck property-based testing, integration tests, and test organization best practices. Use when Codex needs to perform Fsharp Testing tasks, or when the user explicitly mentions fsharp-testing.
---
