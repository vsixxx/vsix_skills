...
description: Benchmark, diagnose, and optimize OpenClaw test and plugin-suite runtime, import hotspots, CPU/RSS, heap growth, and slow coverage paths. Use when Codex needs to perform Openclaw Test Performance tasks, or when the user explicitly mentions openclaw-test-performance.
---
