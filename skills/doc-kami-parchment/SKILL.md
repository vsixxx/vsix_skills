...
description: Warm parchment canvas (#f5f4ed), monochrome ink-blue accent (#1B365D), one serif family, and editorial-grade typography. Use when Codex needs to perform Doc Kami Parchment tasks, or when the user explicitly mentions doc-kami-parchment.
---
