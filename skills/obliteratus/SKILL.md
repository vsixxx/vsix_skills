---
name: obliteratus
description: 'OBLITERATUS: abliterate LLM refusals (diff-in-means). Use when Codex needs to perform Obliteratus tasks, or when the user explicitly mentions obliteratus.'
---
