---
name: pinggy-tunnel
description: Zero-install localhost tunnels over SSH via Pinggy. Use when Codex needs to perform Pinggy Tunnel tasks, or when the user explicitly mentions pinggy-tunnel.
---
