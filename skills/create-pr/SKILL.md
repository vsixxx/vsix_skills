---
name: create-pr
description: Create a pull request, optionally for the issue provided as argument Use when Codex needs to perform Create PR tasks, or when the user explicitly mentions create-pr.
---
