---
name: content-audit
description: Audit GDD-specified content counts against implemented content. Identifies what's planned vs built. Use when Codex needs to perform Content Audit tasks, or when the user explicitly mentions content-audit.
---
