---
name: onboard
description: Generates a contextual onboarding document for a new contributor or agent joining the project. Summarizes project state, architecture, conventions, and current priorities relevant to the specified role or area. Use when Codex needs to perform Onboard tasks, or when the user explicitly mentions onboard.
---
