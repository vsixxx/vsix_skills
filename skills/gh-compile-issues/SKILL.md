...
description: 'Triage N GitHub issues into a coverage matrix: fetch each, check current code, classify already-done/quick-fix/design/defer with cited evidence. Use when Codex needs to perform Gh Compile Issues tasks, or when the user explicitly mentions gh-compile-issues.'
---
