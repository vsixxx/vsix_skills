---
name: pptx
description: Read, generate, and adjust PowerPoint slides, layouts, and templates. Useful for executive decks, training material, and product reviews. Use when Codex needs to perform PPTX tasks, or when the user explicitly mentions pptx.
---
