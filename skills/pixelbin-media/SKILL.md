---
name: pixelbin-media
description: Generate and edit images and videos with an 85+ API portfolio and build visually appealing website pages via Pixelbin. Use when Codex needs to perform Pixelbin Media tasks, or when the user explicitly mentions pixelbin-media.
---
