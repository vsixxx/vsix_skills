...
description: WireGuard VPN server setup, peer configuration, key generation, split tunneling vs full tunnel routing, and remote access to a home network from mobile and laptop clients. Use when Codex needs to perform Homelab Wireguard Vpn tasks, or when the user explicitly mentions homelab-wireguard-vpn.
---
