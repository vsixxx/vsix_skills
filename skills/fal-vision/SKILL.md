---
name: fal-vision
description: Analyze images — segment objects, detect, run OCR, describe, and answer visual questions via fal.ai vision models. Use when Codex needs to perform Fal Vision tasks, or when the user explicitly mentions fal-vision.
---
