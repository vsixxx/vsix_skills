---
name: investigate
description: Systematic debugging with root cause investigation. (gstack) Use when Codex needs to perform Investigate tasks, or when the user explicitly mentions investigate.
---
