---
name: asset-audit
description: Audits game assets for compliance with naming conventions, file size budgets, format standards, and pipeline requirements. Identifies orphaned assets, missing references, and standard violations. Use when Codex needs to perform Asset Audit tasks, or when the user explicitly mentions asset-audit.
---
