---
name: pair-agent
description: Pair a remote AI agent with your browser. (gstack) Use when Codex needs to perform Pair Agent tasks, or when the user explicitly mentions pair-agent.
---
