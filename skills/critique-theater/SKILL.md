...
description: 5-dimension critique panel; emits the critique.score signal that drives devloop convergence. Use when Codex needs to perform Critique Theater tasks, or when the user explicitly mentions critique-theater.
---
