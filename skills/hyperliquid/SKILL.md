---
name: hyperliquid
description: Hyperliquid market data, account history, trade review. Use when Codex needs to perform Hyperliquid tasks, or when the user explicitly mentions hyperliquid.
---
...
The script reads `a local `.env` file or shell environment` for two optional defaults:
...
Helper script: `${CODEX_HOME:-$HOME/.codex}/skills/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ${CODEX_HOME:-$HOME/.codex}/skills/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `a local `.env` file or shell environment`.
...
```bash
python3 ${CODEX_HOME:-$HOME/.codex}/skills/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ${CODEX_HOME:-$HOME/.codex}/skills/hyperliquid/scripts/hyperliquid_client.py \
