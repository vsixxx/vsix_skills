...
description: 16-column grid, one saturated accent, and 22 locked layouts (Klein Blue, Lemon, Mint, Safety Orange). Use when Codex needs to perform Deck Swiss International tasks, or when the user explicitly mentions deck-swiss-international.
---
