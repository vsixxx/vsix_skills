---
name: fal-tryon
description: Virtual try-on — see how clothes look on a person via fal.ai's hosted try-on models. Useful for ecommerce, lookbooks, and styling experiments. Use when Codex needs to perform Fal Tryon tasks, or when the user explicitly mentions fal-tryon.
---
