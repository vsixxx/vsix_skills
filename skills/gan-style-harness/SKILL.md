...
description: GAN-inspired Generator-Evaluator agent harness for building high-quality applications autonomously. Based on Anthropic's March 2026 harness design paper. Use when Codex needs to perform Gan Style Harness tasks, or when the user explicitly mentions gan-style-harness.
---
