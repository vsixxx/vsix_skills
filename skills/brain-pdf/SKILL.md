---
name: brain-pdf
description: Generate a publication-quality PDF from any brain page via the gstack make-pdf binary. Strips YAML frontmatter, sanitizes emoji, applies running headers and page numbers. Brain page is always the source of truth; PDF is a rendering. Use when Codex needs to perform Brain PDF tasks, or when the user explicitly mentions brain-pdf.
---
