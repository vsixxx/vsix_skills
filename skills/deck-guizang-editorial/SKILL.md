...
description: 'Editorial magazine meets e-ink: 10 layouts and 5 palettes (Ink, Indigo Porcelain, Forest Ink, Kraft Paper, Dune). Use when Codex needs to perform Deck Guizang Editorial tasks, or when the user explicitly mentions deck-guizang-editorial.'
---
