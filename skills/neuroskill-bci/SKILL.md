---
name: neuroskill-bci
description: Connect to a running NeuroSkill instance and incorporate the user's real-time cognitive and emotional state (focus, relaxation, mood, cognitive load, drowsiness, heart rate, HRV, sleep staging, and 40+ derived EXG scores) into responses. Requires a BCI wearable (Muse 2/S or OpenBCI) and the NeuroSkill desktop app running locally. Use when Codex needs to perform Neuroskill Bci tasks, or when the user explicitly mentions neuroskill-bci.
---
