...
For positively identified web Work Mode, use this order:
...
Do not choose the MCP artifact app in web Work Mode, even if its tools are visible. For all other environments, use the default order below:
...
- `plugin-support/src/analytics-app-core.md` for shared MCP artifact mechanics, source safety, runtime behavior, and validation helpers.
