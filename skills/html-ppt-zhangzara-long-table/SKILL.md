...
description: 'Open Design''s unit-economics and BYOK cost model: the assumptions, the sensitivity, and why it scales. Built as a decision-grade data & finance deck for CFO, investors. Use when Codex needs to perform HTML Ppt Zhangzara Long Table tasks, or when the user explicitly mentions html-ppt-zhangzara-long-table.'
---
