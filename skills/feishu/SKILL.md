---
name: feishu
description: Work with Feishu or Lark bots, docs, sheets, bitables, approval flows, and OpenAPI/MCP setup without hardcoding credentials. Use when Codex needs to perform Feishu tasks, or when the user explicitly mentions feishu.
---
