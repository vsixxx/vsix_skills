---
name: diagram-maker
description: Create SVG/HTML or Excalidraw diagrams for concepts, architecture, flows, and whiteboards. Use when Codex needs to perform Diagram Maker tasks, or when the user explicitly mentions diagram-maker.
---
