...
description: Use when building PM-facing Public Equity Investing trade pitches, including sparse-context or partial-section requests. Do not use for formal memos; use codexpp-public-equity-memo-builder.
---
...
Default deliverable: full PM-facing trade pitch. A new standalone reader-facing pitch should become a polished standalone HTML trade-pitch report following `plugin-support/shared/html-artifact-standard.md`; use chat only when the user explicitly requests a lightweight response. Let the trade decision, expression, and implementation gates determine the hierarchy. The output should sound like a seasoned portfolio manager forming a research posture, not an analyst filling a template. Do not compress to a quick pitch unless the user explicitly asks for `quick`, `short`, `summary`, `one-pager`, `TL;DR`, red-team-only review, or one specific section.
...
- formal IC memos, investment memos, committee notes, client notes, research notes, or polished PM updates; use `codexpp-public-equity-memo-builder`
...
## Boundary With `codexpp-public-equity-memo-builder`

`long-short-pitch` owns trade construction and pitch discipline. `codexpp-public-equity-memo-builder` owns formal written artifacts and final memo synthesis.
...
Hand off to `codexpp-public-equity-memo-builder` when the pitch needs to become an IC memo, investment memo, committee note, client note, PM update, or formal equity research note. Credit-first memos route to Credit Markets.
...
For a substantive standalone HTML trade-pitch report, load `plugin-support/shared/html-artifact-standard.md` and apply these pitch-specific requirements:
...
- Source discipline: `financial-source-of-truth`, `codexpp-public-equity-financials-normalizer`
- Earnings/post-print: `earnings-preview`, `earnings-deep-dive`
- Valuation/model inputs: `codexpp-public-equity-dcf-model-builder`, `codexpp-public-equity-three-statement-model-builder`, `codexpp-public-equity-comps-valuation`, `codexpp-public-equity-scenario-sensitivity-generator`
...
- Formal memo synthesis: `codexpp-public-equity-memo-builder`
