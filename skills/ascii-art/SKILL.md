---
name: ascii-art
description: 'ASCII art: pyfiglet, cowsay, boxes, image-to-ascii. Use when Codex needs to perform Ascii Art tasks, or when the user explicitly mentions ascii-art.'
---
...
```bash
python3 -m pyfiglet "VSIX" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=VSIX&font=Slant" | boxes -d stone
```
