...
description: Research prediction markets as data sources or oracle signals for products, agents, dashboards, and corporate decision intelligence. Use for source-grounded analysis of market-implied probabilities, caveats, and integration patterns without investment advice. Use when Codex needs to perform Prediction Market Oracle Research tasks, or when the user explicitly mentions prediction-market-oracle-research.
---
