...
description: Provision SaaS services + sync creds via Stripe Projects. Use when Codex needs to perform Stripe Projects tasks, or when the user explicitly mentions stripe-projects.
---
