...
description: A margin-recovery diagnosis for a regional grocery chain — the governing thought, the driver tree, the priorities, and the roadmap. Built as a decision-grade consulting deck for client sponsor, steering committee. Use when Codex needs to perform HTML Ppt Zhangzara Mat tasks, or when the user explicitly mentions html-ppt-zhangzara-mat.
---
