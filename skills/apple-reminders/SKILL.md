...
description: 'Apple Reminders via remindctl: add, list, complete. Use when Codex needs to perform Apple Reminders tasks, or when the user explicitly mentions apple-reminders.'
---
