---
name: things-mac
description: Add, update, list, search, or inspect Things 3 todos, inbox, today, projects, areas, and tags on macOS. Use when Codex needs to perform Things Mac tasks, or when the user explicitly mentions things-mac.
---
