---
name: wxt
description: Build browser extensions with WXT - a next-gen framework with file-based entrypoints, Vite builds, auto-imports, typed storage with migrations, content script UIs, and multi-browser MV2/MV3 support. Use when Codex needs to perform Wxt tasks, or when the user explicitly mentions wxt.
---
