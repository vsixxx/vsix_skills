---
name: graincrawl
description: 'Granola archive: search, sync freshness, notes, transcripts, panels, SQL counts, and Graincrawl repo work. Use when Codex needs to perform Graincrawl tasks, or when the user explicitly mentions graincrawl.'
---
