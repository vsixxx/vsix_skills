...
description: Run, watch, debug, and summarize OpenClaw full release CI, release checks, live provider gates, install/update proofs, and release-secret preflights. Use when Codex needs to perform Release Openclaw Ci tasks, or when the user explicitly mentions release-openclaw-ci.
---
