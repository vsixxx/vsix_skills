---
name: publish
description: Share brain pages as beautiful password-protected HTML with zero LLM calls Use when Codex needs to perform Publish tasks, or when the user explicitly mentions publish.
---
