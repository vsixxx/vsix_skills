---
name: fal-restore
description: Restore and fix image quality — deblur, denoise, fix faces, and restore old documents using fal.ai's hosted restoration models. Use when Codex needs to perform Fal Restore tasks, or when the user explicitly mentions fal-restore.
---
