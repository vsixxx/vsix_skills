---
name: gstack-codex
description: OpenAI Codex CLI wrapper — three modes. (gstack) Use when Codex needs to perform Gstack Codex tasks, or when the user explicitly mentions gstack-codex.
---
