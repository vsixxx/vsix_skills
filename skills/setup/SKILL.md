---
name: setup
description: Set up GBrain with auto-provision Supabase or PGLite, AGENTS.md injection, first import Use when Codex needs to perform Setup tasks, or when the user explicitly mentions setup.
---
