---
name: map-systems
description: Decompose a game concept into individual systems, map dependencies, prioritize design order, and create the systems index. Use when Codex needs to perform Map Systems tasks, or when the user explicitly mentions map-systems.
---
