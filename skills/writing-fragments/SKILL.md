...
description: Writing, explore — mine raw fragments, no structure yet. Use when Codex needs to perform Writing Fragments tasks, or when the user explicitly mentions writing-fragments.
---
