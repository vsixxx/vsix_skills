...
description: Segmenting home networks into VLANs for IoT, guest, trusted, and server traffic using UniFi, pfSense/OPNsense, and MikroTik — including switch trunk config, firewall rules, and wireless SSID mapping. Use when Codex needs to perform Homelab Vlan Segmentation tasks, or when the user explicitly mentions homelab-vlan-segmentation.
---
