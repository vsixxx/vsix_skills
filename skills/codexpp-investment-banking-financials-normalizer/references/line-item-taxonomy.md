...
- [Income statement starter map](#income-statement-starter-map)
- [Balance sheet starter map](#balance-sheet-starter-map)
- [Cash flow starter map](#cash-flow-starter-map)
- [KPI handling](#kpi-handling)
