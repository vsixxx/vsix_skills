---
name: perl-testing
description: Perl testing patterns using Test2::V0, Test::More, prove runner, mocking, coverage with Devel::Cover, and TDD methodology. Use when Codex needs to perform Perl Testing tasks, or when the user explicitly mentions perl-testing.
---
