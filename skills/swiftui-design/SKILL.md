---
name: swiftui-design
description: SwiftUI 前端设计 skill — anti AI-slop rules, design direction advisor, brand asset protocol, and five-dimension review. Works with Claude Code, Cursor, Codex, and OpenCode. Use when Codex needs to perform Swiftui Design tasks, or when the user explicitly mentions swiftui-design.
---
