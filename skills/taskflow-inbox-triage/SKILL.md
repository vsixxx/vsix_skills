...
description: Example TaskFlow pattern for inbox triage, intent routing, waiting on replies, and later summaries. Use when Codex needs to perform Taskflow Inbox Triage tasks, or when the user explicitly mentions taskflow-inbox-triage.
---
