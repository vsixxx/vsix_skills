---
name: simple-deck
description: 'Open Design''s operating review: growth, burn, and the concrete path to sustainability without losing the open ethos. Built as a decision-grade corporate strategy deck for leadership team. Use when Codex needs to perform Simple Deck tasks, or when the user explicitly mentions simple-deck.'
---
