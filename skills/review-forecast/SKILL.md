...
- Use saved Sales user context for company-specific forecast category interpretation, close-date norms, stage exit criteria, approval rules, and source preferences only when read through `sales:codexpp-sales-user-context`.
