---
name: findmy
description: Track Apple devices/AirTags via FindMy.app on macOS. Use when Codex needs to perform Findmy tasks, or when the user explicitly mentions findmy.
---
