---
name: qmd
description: Search personal knowledge bases, notes, docs, and meeting transcripts locally using qmd — a hybrid retrieval engine with BM25, vector search, and LLM reranking. Supports CLI and MCP integration. Use when Codex needs to perform Qmd tasks, or when the user explicitly mentions qmd.
---
