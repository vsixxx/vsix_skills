---
name: wacli
description: Send third-party WhatsApp messages or sync/search WhatsApp history via wacli, not normal active chats. Use when Codex needs to perform Wacli tasks, or when the user explicitly mentions wacli.
---
