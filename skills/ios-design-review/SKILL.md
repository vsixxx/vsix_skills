...
description: Visual design audit for iOS apps on real hardware. (gstack) Use when Codex needs to perform Ios Design Review tasks, or when the user explicitly mentions ios-design-review.
---
