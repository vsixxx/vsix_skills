...
description: Use gitcrawl to search duplicate OpenClaw PRs/issues, group related work in prtags, and sync duplicate state to GitHub. Use when Codex needs to perform Tag Duplicate Prs Issues tasks, or when the user explicitly mentions tag-duplicate-prs-issues.
---
