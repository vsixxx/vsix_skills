...
description: Patterns and architectures for autonomous Claude Code loops — from simple sequential pipelines to RFC-driven multi-agent DAG systems. Use when Codex needs to perform Autonomous Loops tasks, or when the user explicitly mentions autonomous-loops.
---
