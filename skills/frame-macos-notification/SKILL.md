...
description: Realistic macOS notification banner with app icon, title, and body, suited to video overlays or product teasers. Use when Codex needs to perform Frame Macos Notification tasks, or when the user explicitly mentions frame-macos-notification.
---
