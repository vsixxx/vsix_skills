...
description: 'A self-contained WebGL2 hero: layered aurora light curtains warped over a night sky scattered with stars; move the cursor to sway the veil. Use when Codex needs to perform Webgl Aurora Veil tasks, or when the user explicitly mentions webgl-aurora-veil.'
---
