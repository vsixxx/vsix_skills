---
name: healthcheck
description: 'Audit/harden OpenClaw hosts: SSH, firewall, updates, exposure, backups, disk encryption, gateway security. Use when Codex needs to perform Healthcheck tasks, or when the user explicitly mentions healthcheck.'
---
