---
name: ib-pitch-book
description: 'Open Design''s investor pitch book: market map, moat, unit economics, and the ask — analyst-grade and diligence-ready. Built as a decision-grade fundraising pitch deck for growth-equity investors. Use when Codex needs to perform Ib Pitch Book tasks, or when the user explicitly mentions ib-pitch-book.'
---
