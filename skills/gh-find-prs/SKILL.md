---
name: gh-find-prs
description: Survey open CodeWhale PRs and triage each for mergeability and disposition against the real landing branch. Use when Codex needs to perform Gh Find Prs tasks, or when the user explicitly mentions gh-find-prs.
---
