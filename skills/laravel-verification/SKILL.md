...
description: 'Verification loop for Laravel projects: env checks, linting, static analysis, tests with coverage, security scans, and deployment readiness. Use when Codex needs to perform Laravel Verification tasks, or when the user explicitly mentions laravel-verification.'
---
