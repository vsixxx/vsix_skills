---
name: openhue
description: Control Philips Hue lights, scenes, rooms via OpenHue CLI. Use when Codex needs to perform Openhue tasks, or when the user explicitly mentions openhue.
---
