---
name: shadcn-ui
description: Build UI components with shadcn/ui. Pairs with the Stitch design loop to ship structured, accessible components quickly. Use when Codex needs to perform Shadcn Ui tasks, or when the user explicitly mentions shadcn-ui.
---
