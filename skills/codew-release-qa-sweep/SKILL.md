...
description: 'Use before claiming CodeWhale release work is done: run the full gate sweep and list the manual QA targets. Use when Codex needs to perform Codew Release Qa Sweep tasks, or when the user explicitly mentions codew-release-qa-sweep.'
---
