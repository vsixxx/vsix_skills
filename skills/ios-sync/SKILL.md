---
name: ios-sync
description: Regenerate the iOS debug bridge against the latest upstream gstack templates. (gstack) Use when Codex needs to perform Ios Sync tasks, or when the user explicitly mentions ios-sync.
---
