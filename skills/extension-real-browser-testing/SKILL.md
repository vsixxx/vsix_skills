...
description: Test browser extensions in real browsers using built artifacts, Edge + Playwright automation, runtime-message triggering, DOM debugging, and truthful screenshot capture. Use when Codex needs to perform Extension Real Browser Testing tasks, or when the user explicitly mentions extension-real-browser-testing.
---
