...
description: Clone/create/fork repos; manage remotes, releases. Use when Codex needs to perform GitHub Repo Management tasks, or when the user explicitly mentions github-repo-management.
---
