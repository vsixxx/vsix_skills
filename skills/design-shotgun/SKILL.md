---
name: design-shotgun
description: 'Design shotgun: generate multiple AI design variants, open a comparison board, collect structured feedback, and iterate. (gstack) Use when Codex needs to perform Design Shotgun tasks, or when the user explicitly mentions design-shotgun.'
---
