...
description: Idiomatic Kotlin patterns, best practices, and conventions for building robust, efficient, and maintainable Kotlin applications with coroutines, null safety, and DSL builders. Use when Codex needs to perform Kotlin Patterns tasks, or when the user explicitly mentions kotlin-patterns.
---
