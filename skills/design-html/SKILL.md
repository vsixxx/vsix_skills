---
name: design-html
description: 'Design finalization: generates production-quality Pretext-native HTML/CSS. (gstack) Use when Codex needs to perform Design HTML tasks, or when the user explicitly mentions design-html.'
---
