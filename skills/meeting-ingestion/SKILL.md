...
description: Ingest meeting transcripts into brain pages with attendee enrichment, entity propagation, and timeline merge. A meeting is NOT fully ingested until the enrich skill has processed every entity. Use when Codex needs to perform Meeting Ingestion tasks, or when the user explicitly mentions meeting-ingestion.
---
