...
description: Default reference pipeline for the figma-migration taskKind — figma-extract → token-map → generate → critique. Use when Codex needs to perform Od Figma Migration tasks, or when the user explicitly mentions od-figma-migration.
---
