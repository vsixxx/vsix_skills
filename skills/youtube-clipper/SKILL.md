...
description: YouTube clip generation and editing with automated workflows — pull source video, slice highlights, add captions, and export. Use when Codex needs to perform YouTube Clipper tasks, or when the user explicitly mentions youtube-clipper.
---
