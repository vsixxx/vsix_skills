---
name: pr-ready
description: Resolve CI failures, merge conflicts, or local branch changes to get a PR ready Use when Codex needs to perform PR Ready tasks, or when the user explicitly mentions pr-ready.
---
