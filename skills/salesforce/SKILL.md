...
7. Evaluate wildcard usage carefully. Broad `LIKE '%...%'` filters are candidate discovery, can defeat codexpp-sales-indexes, and are not proof of the canonical record.
