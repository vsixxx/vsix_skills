...
description: 'Open Design''s seed pitch: the open, local alternative to closed AI design — why now, the wedge, and the ask. Built as a decision-grade fundraising pitch deck for pre-seed & seed VCs. Use when Codex needs to perform Fs Creative Voltage tasks, or when the user explicitly mentions fs-creative-voltage.'
---
