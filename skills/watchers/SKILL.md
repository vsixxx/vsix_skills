---
name: watchers
description: Poll RSS, JSON APIs, and GitHub with watermark dedup. Use when Codex needs to perform Watchers tasks, or when the user explicitly mentions watchers.
---
