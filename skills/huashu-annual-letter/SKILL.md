...
description: 'Open Design''s annual letter to its community: the year''s story, what it learned, and where it''s going next. Built as a decision-grade corporate strategy deck for community, contributors, investors. Use when Codex needs to perform Huashu Annual Letter tasks, or when the user explicitly mentions huashu-annual-letter.'
---
