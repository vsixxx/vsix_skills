---
name: devex-review
description: Live developer experience audit. (gstack) Use when Codex needs to perform Devex Review tasks, or when the user explicitly mentions devex-review.
---
