---
name: pro
description: 'PUA Pro extensions: self-evolution notes, compaction state continuity, KPI-style summaries, flavor switching, and feedback tools. Use when Codex needs to perform Pro tasks, or when the user explicitly mentions pro.'
---
