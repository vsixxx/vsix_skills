...
description: Present HTML on connected OpenClaw node canvases, navigate/eval/snapshot, and debug canvas host URLs. Use when Codex needs to perform Openclaw Canvas tasks, or when the user explicitly mentions openclaw-canvas.
---
