---
name: fal-lip-sync
description: Create talking head videos and lip sync audio to video via fal.ai. Useful for explainer avatars, multilingual dubbing previews, and social cuts. Use when Codex needs to perform Fal Lip Sync tasks, or when the user explicitly mentions fal-lip-sync.
---
