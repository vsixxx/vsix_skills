...
description: 'Verification loop for Django projects: migrations, linting, tests with coverage, security scans, and deployment readiness checks before release or PR. Use when Codex needs to perform Django Verification tasks, or when the user explicitly mentions django-verification.'
---
