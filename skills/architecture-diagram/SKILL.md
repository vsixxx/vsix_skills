...
description: Dark-themed SVG architecture/cloud/infra diagrams as HTML. Use when Codex needs to perform Architecture Diagram tasks, or when the user explicitly mentions architecture-diagram.
---
