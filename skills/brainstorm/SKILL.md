---
name: brainstorm
description: Guided game concept ideation — from zero idea to a structured game concept document. Uses professional studio ideation techniques, player psychology frameworks, and structured creative exploration. Use when Codex needs to perform Brainstorm tasks, or when the user explicitly mentions brainstorm.
---
