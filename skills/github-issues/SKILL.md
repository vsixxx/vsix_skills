---
name: github-issues
description: Create, triage, label, assign GitHub issues via gh or REST. Use when Codex needs to perform GitHub Issues tasks, or when the user explicitly mentions github-issues.
---
