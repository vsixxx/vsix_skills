...
description: Read a book, article, transcript, or case study through the lens of a specific strategic problem you're facing. Produces an applied playbook that maps the source onto the problem and gives short/medium/long-term recommendations. NOT for general book summaries. Use when Codex needs to perform Strategic Reading tasks, or when the user explicitly mentions strategic-reading.
---
