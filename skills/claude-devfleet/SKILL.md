...
description: Orchestrate multi-agent coding tasks via Claude DevFleet — plan projects, dispatch parallel agents in isolated worktrees, monitor progress, and read structured reports. Use when Codex needs to perform Claude Devfleet tasks, or when the user explicitly mentions claude-devfleet.
---
