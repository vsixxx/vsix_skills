...
description: Investigate OpenClaw pnpm test memory growth, Vitest OOMs, RSS spikes, and heap snapshot deltas. Use when Codex needs to perform Openclaw Test Heap Leaks tasks, or when the user explicitly mentions openclaw-test-heap-leaks.
---
