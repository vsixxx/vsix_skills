---
name: ingest
description: Route content to specialized ingestion skills. Detects input type and delegates. Use when Codex needs to perform Ingest tasks, or when the user explicitly mentions ingest.
---
