---
name: start
description: First-time onboarding — asks where you are, then guides you to the right workflow. No assumptions. Use when Codex needs to perform Start tasks, or when the user explicitly mentions start.
---
