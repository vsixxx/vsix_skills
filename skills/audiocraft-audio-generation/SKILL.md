...
description: 'AudioCraft: MusicGen text-to-music, AudioGen text-to-sound. Use when Codex needs to perform Audiocraft Audio Generation tasks, or when the user explicitly mentions audiocraft-audio-generation.'
---
