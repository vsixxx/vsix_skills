---
name: feishu-wiki
description: Feishu knowledge base navigation. Activate when user mentions knowledge base, wiki, or wiki links. Use when Codex needs to perform Feishu Wiki tasks, or when the user explicitly mentions feishu-wiki.
---
