...
description: プロジェクトガイドラインスキル（例） Use when Codex needs to perform Project Guidelines Example tasks, or when the user explicitly mentions project-guidelines-example.
---
