...
description: Use this plugin when the user wants a "Bold Signal Frame" HyperFrames motion video — Bold colored card on a dark gradient — big section number, nav breadcrumb, orange card sliding in, title rising. Use when Codex needs to perform Video Template Frame Bold Signal tasks, or when the user explicitly mentions video-template-frame-bold-signal.
---
