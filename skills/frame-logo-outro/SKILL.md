...
description: Segmented logo assembly, glow bloom, and tagline reveal for video outros or brand closing frames. Use when Codex needs to perform Frame Logo Outro tasks, or when the user explicitly mentions frame-logo-outro.
---
