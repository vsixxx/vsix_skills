...
description: 'Hunt the issue/PR queue for highest value-over-risk wins: clean focused community PRs, already-implemented issues to close, safe quick-fixes. Use when Codex needs to perform Gh Treasure Hunt tasks, or when the user explicitly mentions gh-treasure-hunt.'
---
