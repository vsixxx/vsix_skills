---
name: ordercli
description: Foodora-only CLI for checking past orders and active order status (Deliveroo WIP). Use when Codex needs to perform Ordercli tasks, or when the user explicitly mentions ordercli.
---
