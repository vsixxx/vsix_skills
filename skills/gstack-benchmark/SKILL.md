...
description: Performance regression detection using the browse daemon. (gstack) Use when Codex needs to perform Gstack Benchmark tasks, or when the user explicitly mentions gstack-benchmark.
---
