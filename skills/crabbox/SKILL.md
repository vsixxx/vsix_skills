---
name: crabbox
description: Use the Crabbox wrapper for OpenClaw remote validation across Linux, macOS, Windows, and WSL2, including delegated Blacksmith Testbox proof. Report the actual provider and id. Use when Codex needs to perform Crabbox tasks, or when the user explicitly mentions crabbox.
---
