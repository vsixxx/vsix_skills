---
name: ios-clean
description: 'Remove the DebugBridge SPM package and all #if DEBUG wiring from an iOS app. (gstack) Use when Codex needs to perform Ios Clean tasks, or when the user explicitly mentions ios-clean.'
---
