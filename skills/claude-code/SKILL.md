---
name: claude-code
description: Delegate coding to Claude Code CLI (features, PRs). Use when Codex needs to perform Claude Code tasks, or when the user explicitly mentions claude-code.
---
