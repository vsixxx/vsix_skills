...
description: Run macOS Parallels smoke with Discord send, host verification, host reply, and guest readback proof. Use when Codex needs to perform Parallels Discord Roundtrip tasks, or when the user explicitly mentions parallels-discord-roundtrip.
---
