---
name: retrospective
description: Generates a sprint or milestone retrospective by analyzing completed work, velocity, blockers, and patterns. Produces actionable insights for the next iteration. Use when Codex needs to perform Retrospective tasks, or when the user explicitly mentions retrospective.
---
