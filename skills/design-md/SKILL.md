---
name: design-md
description: Author/validate/export Google's DESIGN.md token spec files. Use when Codex needs to perform Design Md tasks, or when the user explicitly mentions design-md.
---
...
the polished artifact design skill. This skill is for the *formal spec file* itself.
