...
description: Pre-deployment checks for router and switch configuration, including dangerous commands, duplicate addresses, subnet overlaps, stale references, management-plane risk, and IOS-style security hygiene. Use when Codex needs to perform Network Config Validation tasks, or when the user explicitly mentions network-config-validation.
---
