---
name: excalidraw
description: Hand-drawn Excalidraw JSON diagrams (arch, flow, seq). Use when Codex needs to perform Excalidraw tasks, or when the user explicitly mentions excalidraw.
---
