---
name: bug-report
description: Creates a structured bug report from a description, or analyzes code to identify potential bugs. Ensures every bug report has full reproduction steps, severity assessment, and context. Use when Codex needs to perform Bug Report tasks, or when the user explicitly mentions bug-report.
---
