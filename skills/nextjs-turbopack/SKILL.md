...
description: Next.js 16+ and Turbopack — incremental bundling, FS caching, dev speed, and when to use Turbopack vs webpack. Use when Codex needs to perform Nextjs Turbopack tasks, or when the user explicitly mentions nextjs-turbopack.
---
