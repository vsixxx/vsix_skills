---
name: gbrain-advisor
description: 'Proactive "make the most of gbrain" coaching. Runs `gbrain advisor` on a cadence and pings the user with the top high-leverage actions for their brain: version drift, pending migrations, stalled jobs, low embed coverage, setup smells, and uninstalled brain skills. Read-only; always asks before fixing. Use when Codex needs to perform Gbrain Advisor tasks, or when the user explicitly mentions gbrain-advisor.'
---
