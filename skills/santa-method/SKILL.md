---
name: santa-method
description: Multi-agent adversarial verification with convergence loop. Two independent review agents must both pass before output ships. Use when Codex needs to perform Santa Method tasks, or when the user explicitly mentions santa-method.
---
