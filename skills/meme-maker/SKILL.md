---
name: meme-maker
description: Search meme templates, suggest formats, and generate local or hosted image memes. Use when Codex needs to perform Meme Maker tasks, or when the user explicitly mentions meme-maker.
---
