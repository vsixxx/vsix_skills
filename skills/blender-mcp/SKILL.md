---
name: blender-mcp
description: Control Blender through a socket connection to the blender-mcp addon. Create 3D objects, materials, animations, and run arbitrary Blender Python (bpy) code. Use when user wants to create or modify anything in Blender.
---
...
Control a running Blender instance from the current agent via socket on TCP port 9876.
