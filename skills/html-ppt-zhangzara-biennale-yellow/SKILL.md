...
description: A curatorial deck for a contemporary art biennale — the thesis, the rooms, the works, and the visitor journey. Built as a decision-grade design craft deck for museum board, curators. Use when Codex needs to perform HTML Ppt Zhangzara Biennale Yellow tasks, or when the user explicitly mentions html-ppt-zhangzara-biennale-yellow.
---
