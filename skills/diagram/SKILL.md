---
name: diagram
description: 'Turn an English description (or mermaid source) into a diagram triplet: the source, an editable .excalidraw file you can open (gstack) Use when Codex needs to perform Diagram tasks, or when the user explicitly mentions diagram.'
---
