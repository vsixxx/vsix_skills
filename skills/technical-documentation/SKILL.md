...
description: Build and review high-quality technical docs as well as agent instruction files in your repository. Use when Codex needs to perform Technical Documentation tasks, or when the user explicitly mentions technical-documentation.
---
