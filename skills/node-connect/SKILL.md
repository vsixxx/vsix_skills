---
name: node-connect
description: Diagnose OpenClaw Android, iOS, or macOS node pairing, QR/setup code, route, auth, and connection failures. Use when Codex needs to perform Node Connect tasks, or when the user explicitly mentions node-connect.
---
