---
name: issue
description: Create or update GitHub issues with correct Remotion naming and safe multiline Markdown handling Use when Codex needs to perform Issue tasks, or when the user explicitly mentions issue.
---
