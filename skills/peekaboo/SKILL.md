---
name: peekaboo
description: Capture and automate macOS UI with the Peekaboo CLI. Use when Codex needs to perform Peekaboo tasks, or when the user explicitly mentions peekaboo.
---
