...
description: 'Open Design as an enterprise design platform: a buyer-forwardable proposal for a design-org''s economic buyer — pain, value, ROI, rollout. Built as a decision-grade B2B sales deck for economic buyer, design VP, procurement. Use when Codex needs to perform Fs Electric Studio tasks, or when the user explicitly mentions fs-electric-studio.'
---
