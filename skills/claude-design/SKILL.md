---
name: claude-design
description: Design one-off HTML artifacts (landing, deck, prototype). Use when Codex needs to perform Claude Design tasks, or when the user explicitly mentions claude-design.
---
