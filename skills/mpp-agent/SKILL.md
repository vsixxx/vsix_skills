---
name: mpp-agent
description: Pay HTTP 402 APIs via Machine Payments Protocol (MPP). Use when Codex needs to perform Mpp Agent tasks, or when the user explicitly mentions mpp-agent.
---
