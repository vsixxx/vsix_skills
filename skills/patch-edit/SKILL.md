---
name: patch-edit
description: Apply one rewrite-plan step at a time as small reviewable file edits, never rewriting whole files when a localised change suffices. Use when Codex needs to perform Patch Edit tasks, or when the user explicitly mentions patch-edit.
---
