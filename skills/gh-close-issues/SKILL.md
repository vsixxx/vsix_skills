...
description: Close resolved CodeWhale issues only after verifying the landed commit/behavior, with a positive crediting comment; never from title alone. Use when Codex needs to perform Gh Close Issues tasks, or when the user explicitly mentions gh-close-issues.
---
