---
name: spike
description: Throwaway experiments to validate an idea before build. Use when Codex needs to perform Spike tasks, or when the user explicitly mentions spike.
---
