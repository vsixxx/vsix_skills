---
name: add-effect
description: Add a new effect to @remotion/effects, including implementation, package exports, docs, demos, preview images, Remotion skill updates, tests, formatting, and builds. Use when Codex needs to perform Add Effect tasks, or when the user explicitly mentions add-effect.
---
