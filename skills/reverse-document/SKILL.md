...
description: Generate design or architecture documents from existing implementation. Works backwards from code/prototypes to create missing planning docs. Use when Codex needs to perform Reverse Document tasks, or when the user explicitly mentions reverse-document.
---
