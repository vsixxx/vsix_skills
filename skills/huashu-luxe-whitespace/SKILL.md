...
description: A market-entry study for a luxury skincare brand entering Asia — segmentation, positioning, channel, and the phased plan. Built as a decision-grade consulting deck for client leadership. Use when Codex needs to perform Huashu Luxe Whitespace tasks, or when the user explicitly mentions huashu-luxe-whitespace.
---
