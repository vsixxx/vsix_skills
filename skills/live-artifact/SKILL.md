---
name: live-artifact
description: Create refreshable, auditable Open Design artifacts backed by connector or local data. Trigger when the user asks for live dashboards, refreshable reports, synced views, or reusable data-backed artifacts. Use when Codex needs to perform Live Artifact tasks, or when the user explicitly mentions live-artifact.
---
