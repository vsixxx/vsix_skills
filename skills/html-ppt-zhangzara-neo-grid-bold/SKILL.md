...
description: A designer's portfolio narrative for a senior interview — three case studies, the craft, and the judgment behind each. Built as a decision-grade career deck for hiring panel. Use when Codex needs to perform HTML Ppt Zhangzara Neo Grid Bold tasks, or when the user explicitly mentions html-ppt-zhangzara-neo-grid-bold.
---
