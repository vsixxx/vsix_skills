---
name: fix-dependabot
description: Fix a Dependabot PR by updating all monorepo instances of the dependency, running bun install, and pushing Use when Codex needs to perform Fix Dependabot tasks, or when the user explicitly mentions fix-dependabot.
---
