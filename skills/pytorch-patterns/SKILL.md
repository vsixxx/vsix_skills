...
description: PyTorch deep learning patterns and best practices for building robust, efficient, and reproducible training pipelines, model architectures, and data loading. Use when Codex needs to perform Pytorch Patterns tasks, or when the user explicitly mentions pytorch-patterns.
---
