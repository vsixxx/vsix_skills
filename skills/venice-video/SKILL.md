---
name: venice-video
description: Video generation and transcription workflows via the Venice.ai API. Use when Codex needs to perform Venice Video tasks, or when the user explicitly mentions venice-video.
---
