...
description: 'A self-contained WebGL2 hero: a living Voronoi network with drifting feature points, palette-keyed cells and glowing boundaries; move the cursor to push the cells. Use when Codex needs to perform Webgl Voronoi Cells tasks, or when the user explicitly mentions webgl-voronoi-cells.'
---
