---
name: petdex
description: Install and select animated petdex mascots for Hermes. Use when Codex needs to perform Petdex tasks, or when the user explicitly mentions petdex.
---
