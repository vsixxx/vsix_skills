...
description: Generates videos using Grok. Supports text-to-video and image-to-video. AI视频生成、文生视频、图生视频。 Use when Codex needs to perform Generating Videos tasks, or when the user explicitly mentions generating-videos.
---
