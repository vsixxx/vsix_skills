...
description: 'Open Design''s ''design on your desk'' brand-launch narrative: the market moment, the story, and the proof that converts. Built as a decision-grade marketing & GTM deck for marketing team, press. Use when Codex needs to perform Fs Emerald Editorial tasks, or when the user explicitly mentions fs-emerald-editorial.'
---
