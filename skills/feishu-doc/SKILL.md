---
name: feishu-doc
description: Feishu document read/write operations. Activate when user mentions Feishu docs, cloud docs, or docx links. Use when Codex needs to perform Feishu Doc tasks, or when the user explicitly mentions feishu-doc.
---
