...
description: 'Manage GitHub Issues 2.0 relationships with gh CLI: parent issues, sub-issues, blocked-by, and blocking links. Use when Codex needs to perform Issue Management tasks, or when the user explicitly mentions issue-management.'
---
