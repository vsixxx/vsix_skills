---
name: outlines
description: 'Outlines: structured JSON/regex/Pydantic LLM generation. Use when Codex needs to perform Outlines tasks, or when the user explicitly mentions outlines.'
---
