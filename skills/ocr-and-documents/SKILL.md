...
description: Extract text from PDFs/scans (pymupdf, marker-pdf). Use when Codex needs to perform Ocr And Documents tasks, or when the user explicitly mentions ocr-and-documents.
---
