...
description: Debug OpenClaw model, provider, tool-surface, code-mode, streaming, and live/Crabbox behavior by choosing the right logs, probes, and proof path before changing code. Use when Codex needs to perform Openclaw Debugging tasks, or when the user explicitly mentions openclaw-debugging.
---
