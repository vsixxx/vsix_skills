---
name: setup-deploy
description: Configure deployment settings for /land-and-deploy. Use when Codex needs to perform Setup Deploy tasks, or when the user explicitly mentions setup-deploy.
---
