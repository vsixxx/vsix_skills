...
description: Self-evolving skill optimization via SkillOpt-paper-grounded text-space optimizer. Use when Codex needs to perform Skill Optimizer tasks, or when the user explicitly mentions skill-optimizer.
---
