...
- overwrite a live model, deck, memo, or CRM tracker without confirmation;
...
Use for internal deal team, investment team, committee, finance leadership, or board prep. It may include candid views, concerns, pushback strategy, red lines, valuation sensitivity, diligence concerns, and what not to share.

### External-clean mode
Use for client, counterparty, management, lender, investor, expert, or advisor-facing materials. Remove internal strategy, valuation bottoms, trading intent, negotiation red lines, privileged mental impressions, sensitive internal messages, and anything not appropriate to circulate.
...
- deal tactics or negotiation positions that should not be written externally.
...
- `company-tearsheet`: baseline company, borrower, issuer, fund, or counterparty overview.
...
- `ib-deck-qc`: IB presentation materials and pre-read review.
...
- Vertical skills: use IB, private markets, public markets, credit, or corp-fin skills when the meeting is part of those workflows.
...
- For CRM/deal trackers: propose updates or create an importable tracker; avoid writing directly to production records unless explicitly asked.
