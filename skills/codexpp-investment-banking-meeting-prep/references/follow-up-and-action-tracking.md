...
- **Diligence ask**: evidence, document, data, or support needed.
- **Analysis task**: work the user or team must perform.
- **Relationship follow-up**: message, thank-you, intro, or stakeholder update.
- **Process milestone**: NDA, IOI/LOI, committee date, financing deadline, board date, data room upload, earnings event.
...
Use for counterparties, management teams, clients, lenders, investors, experts, or advisors. Include:
- thanks and purpose;
- concise recap of agreed next steps;
- specific asks with owners and deadlines;
- neutral language;
- no internal strategy, valuation bottoms, red lines, privileged views, trading intent, or sensitive deal tactics.

### Internal follow-up
Use for team, partner, committee, deal team, or investment team. Include:
- candid readout;
- what changed;
- risks and concerns;
- recommended actions;
