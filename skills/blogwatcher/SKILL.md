---
name: blogwatcher
description: Monitor blogs and RSS/Atom feeds via blogwatcher-cli tool. Use when Codex needs to perform Blogwatcher tasks, or when the user explicitly mentions blogwatcher.
---
