...
description: Control Philips Hue lights and scenes via the OpenHue CLI. Use when Codex needs to perform Openclaw Openhue tasks, or when the user explicitly mentions openclaw-openhue.
---
