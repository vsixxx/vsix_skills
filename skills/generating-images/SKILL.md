...
description: Generates images using AI models (Gemini). AI图像生成、文生图、生成图片。 Use when Codex needs to perform Generating Images tasks, or when the user explicitly mentions generating-images.
---
