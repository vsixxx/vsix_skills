...
description: 'A computer-science capstone: an on-device ML keyboard that predicts next words privately — problem, method, evaluation, and defense answers. Built as a decision-grade coursework defense deck for professor, defense committee. Use when Codex needs to perform Fs Notebook Tabs tasks, or when the user explicitly mentions fs-notebook-tabs.'
---
