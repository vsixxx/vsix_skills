...
description: Digital glitch, chromatic offset, and data-corruption title frame for video transitions or cyberpunk heroes. Use when Codex needs to perform Frame Glitch Title tasks, or when the user explicitly mentions frame-glitch-title.
---
