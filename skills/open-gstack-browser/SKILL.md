...
description: Launch GStack Browser — AI-controlled Chromium with the sidebar extension baked in. Use when Codex needs to perform Open Gstack Browser tasks, or when the user explicitly mentions open-gstack-browser.
---
