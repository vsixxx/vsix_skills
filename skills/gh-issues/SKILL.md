---
name: gh-issues
description: Fetch GitHub issues, select candidates, spawn background fix agents, open PRs, and optionally process PR review comments. Use when Codex needs to perform Gh Issues tasks, or when the user explicitly mentions gh-issues.
---
