---
name: python-debugpy
description: 'Debug Python: pdb REPL + debugpy remote (DAP). Use when Codex needs to perform Python Debugpy tasks, or when the user explicitly mentions python-debugpy.'
---
