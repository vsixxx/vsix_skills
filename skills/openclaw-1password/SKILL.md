...
description: Set up and use 1Password CLI for sign-in, desktop integration, and reading or injecting secrets. Use when Codex needs to perform Openclaw 1Password tasks, or when the user explicitly mentions openclaw-1password.
---
