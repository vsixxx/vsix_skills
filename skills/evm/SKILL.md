---
name: evm
description: 'Read-only EVM client: wallets, tokens, gas across 8 chains. Use when Codex needs to perform Evm tasks, or when the user explicitly mentions evm.'
---
