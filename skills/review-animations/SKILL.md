...
description: Reviews animation and motion code against a high craft bar derived from Emil Kowalski's design engineering philosophy. Default to flagging; approval is earned. Use when Codex needs to perform Review Animations tasks, or when the user explicitly mentions review-animations.
---
