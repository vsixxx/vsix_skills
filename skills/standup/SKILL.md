---
name: standup
description: Facilitate a read-only standup across git worktrees, branches, or PRs to compare changes and produce one consolidation plan. Use when Codex needs to perform Standup tasks, or when the user explicitly mentions standup.
---
