...
description: Find or repair a requested batch of small high-confidence non-SDK-boundary OpenClaw bugfix PRs until they are landable. Use when Codex needs to perform Openclaw Landable Bug Sweep tasks, or when the user explicitly mentions openclaw-landable-bug-sweep.
---
