...
description: Rescuing a messy startup deck into a board-grade system — the diagnosis, the page grammar, and the rebuilt proof pages. Built as a decision-grade design craft deck for founders, exec presenter. Use when Codex needs to perform HTML Ppt Zhangzara Block Frame tasks, or when the user explicitly mentions html-ppt-zhangzara-block-frame.
---
