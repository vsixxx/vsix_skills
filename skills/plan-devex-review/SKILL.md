...
description: Interactive developer experience plan review. (gstack) Use when Codex needs to perform Plan Devex Review tasks, or when the user explicitly mentions plan-devex-review.
---
