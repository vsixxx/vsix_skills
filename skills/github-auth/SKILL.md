---
name: github-auth
description: 'GitHub auth setup: HTTPS tokens, SSH keys, gh CLI login. Use when Codex needs to perform GitHub Auth tasks, or when the user explicitly mentions github-auth.'
---
...
elif _agent_env="a local `.env` file or shell environment"; [ -f "$_agent_env" ] && grep -q "^GITHUB_TOKEN=" "$_agent_env"; then
