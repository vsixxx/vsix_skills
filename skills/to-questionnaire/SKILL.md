...
description: Turn a decision you can't fully answer into a questionnaire for someone else to fill in. Use when Codex needs to perform To Questionnaire tasks, or when the user explicitly mentions to-questionnaire.
---
