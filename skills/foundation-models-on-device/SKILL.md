...
description: Apple FoundationModels framework for on-device LLM — text generation, guided generation with @Generable, tool calling, and snapshot streaming in iOS 26+. Use when Codex needs to perform Foundation Models On Device tasks, or when the user explicitly mentions foundation-models-on-device.
---
