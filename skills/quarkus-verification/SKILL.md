...
description: 'Verification loop for Quarkus projects: build, static analysis, tests with coverage, security scans, native compilation, and diff review before release or PR. Use when Codex needs to perform Quarkus Verification tasks, or when the user explicitly mentions quarkus-verification.'
---
