...
description: 54 real design systems (Stripe, Linear, Vercel) as HTML/CSS. Use when Codex needs to perform Popular Web Designs tasks, or when the user explicitly mentions popular-web-designs.
---
...
- **Artifact design** — use for the design *process and taste* (scoping a brief,
  ...
  after a known brand: the artifact design workflow drives the work, this skill supplies
