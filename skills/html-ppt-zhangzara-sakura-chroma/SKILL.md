...
description: A cherry-blossom-season travel photo essay through Kyoto — the arrival, the peak bloom, and the moment that made the trip. Built as a decision-grade story deck for friends, travel readers. Use when Codex needs to perform HTML Ppt Zhangzara Sakura Chroma tasks, or when the user explicitly mentions html-ppt-zhangzara-sakura-chroma.
---
