---
name: help
description: Analyzes what is done and the users query and offers advice on what to do next. Use if user says what should I do next or what do I do now or I'm stuck or I don't know what to do Use when Codex needs to perform Help tasks, or when the user explicitly mentions help.
---
