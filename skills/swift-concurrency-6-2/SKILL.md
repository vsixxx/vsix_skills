...
description: Swift 6.2 Approachable Concurrency — single-threaded by default, @concurrent for explicit background offloading, isolated conformances for main actor types. Use when Codex needs to perform Swift Concurrency 6 2 tasks, or when the user explicitly mentions swift-concurrency-6-2.
---
