...
description: 16:9 HTML deck in editorial-minimalist taste. Warm cream slides, serif display + grotesque body, hairline rules, monospace meta, generous macro-whitespace, one accent. Distilled from Leonxlnx/taste-skill `minimalist-skill`. Use when Codex needs to perform HTML Ppt Taste Editorial tasks, or when the user explicitly mentions html-ppt-taste-editorial.
---
