...
description: Manage Docker containers, images, volumes, networks, and Compose stacks — lifecycle ops, debugging, cleanup, and Dockerfile optimization. Use when Codex needs to perform Docker Management tasks, or when the user explicitly mentions docker-management.
---
