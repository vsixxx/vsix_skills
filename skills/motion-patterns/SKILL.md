...
description: Production-ready animation patterns for React / Next.js — button, modal, toast, stagger, page transitions, exit animations, scroll, and layout — built on motion-foundations tokens and springs. Use when Codex needs to perform Motion Patterns tasks, or when the user explicitly mentions motion-patterns.
---
