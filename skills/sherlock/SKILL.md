---
name: sherlock
description: OSINT username search across 400+ social networks. Hunt down social media accounts by username. Use when Codex needs to perform Sherlock tasks, or when the user explicitly mentions sherlock.
---
