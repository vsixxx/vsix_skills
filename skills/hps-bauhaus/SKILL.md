---
name: hps-bauhaus
description: A visual-design fundamentals course for new brand designers — grid, type, color, and the exercises that build the eye. Built as a decision-grade professional training deck for junior designers, new hires. Use when Codex needs to perform Hps Bauhaus tasks, or when the user explicitly mentions hps-bauhaus.
---
