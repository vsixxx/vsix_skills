---
name: skill-test
description: 'Validate skill files for structural compliance and behavioral correctness. Three modes: static (linter), spec (behavioral), audit (coverage report). Use when Codex needs to perform Skill Test tasks, or when the user explicitly mentions skill-test.'
---
