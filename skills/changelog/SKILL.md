---
name: changelog
description: Auto-generates a changelog from git commits, sprint data, and design documents. Produces both internal and player-facing versions. Use when Codex needs to perform Changelog tasks, or when the user explicitly mentions changelog.
---
