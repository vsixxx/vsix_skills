---
name: canvas
description: Canvas LMS integration — fetch enrolled courses and assignments using API token authentication. Use when Codex needs to perform Canvas tasks, or when the user explicitly mentions canvas.
---
