...
description: 'Open Design''s demo-day pitch: hook, traction, moat, and the raise — built to make a partner sit up by page three. Built as a decision-grade fundraising pitch deck for accelerator partners, angels. Use when Codex needs to perform HTML Ppt Pitch Deck tasks, or when the user explicitly mentions html-ppt-pitch-deck.'
---
