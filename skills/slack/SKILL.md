---
name: slack
description: 'Slack tool actions: send/read/edit/delete messages, react, pin/unpin, list pins/reactions/emoji, member info. Use when Codex needs to perform Slack tasks, or when the user explicitly mentions slack.'
---
