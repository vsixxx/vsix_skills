...
description: 'Article illustrations: type × style × palette consistency. Use when Codex needs to perform Baoyu Article Illustrator tasks, or when the user explicitly mentions baoyu-article-illustrator.'
---
...
Adapted from [baoyu-article-illustrator](https://github.com/JimLiu/baoyu-skills) for the current agent's tool ecosystem.
