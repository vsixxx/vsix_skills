---
name: data-report
description: Turns CSV, Excel, or JSON data into a polished visual report page. Use when Codex needs to perform Data Report tasks, or when the user explicitly mentions data-report.
---
