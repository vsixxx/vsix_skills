---
name: citation-fixer
description: 'Audit and fix citation formatting across brain pages. Ensures every fact has an inline [Source: ...] citation matching the standard format. Extended in v0.25.1: scans for broken tweet/post references that lack actual URLs and resolves them via the host''s X / Twitter API integration. Use when Codex needs to perform Citation Fixer tasks, or when the user explicitly mentions citation-fixer.'
---
