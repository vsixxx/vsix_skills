...
description: Make websites accessible for AI agents. Navigate, click, type, extract, wait — using Chrome with existing login sessions. No LLM API key needed. Use when Codex needs to perform Qiaomu Opencli Browser tasks, or when the user explicitly mentions qiaomu-opencli-browser.
---
