...
description: Use this plugin when the user wants a "Decision Tree" HyperFrames motion video — Animated flowchart with branching paths Use when Codex needs to perform Video Template Frame Decision Tree tasks, or when the user explicitly mentions video-template-frame-decision-tree.
---
