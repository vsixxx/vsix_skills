...
description: Film light leaks, grain, 16:9 letterbox, and large serif type for cinematic openings or chapter cards. Use when Codex needs to perform Frame Light Leak Cinema tasks, or when the user explicitly mentions frame-light-leak-cinema.
---
