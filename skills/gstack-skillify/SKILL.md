...
description: Codify the most recent successful /scrape flow into a permanent browser-skill on disk. (gstack) Use when Codex needs to perform Gstack Skillify tasks, or when the user explicitly mentions gstack-skillify.
---
