...
description: 'Plan and orchestrate multi-slide PowerPoint creation from scratch. Use before generating a full deck with subagents: classify each slide type, enforce visual variety, set typography/spacing rules, and run text-based QA to catch content issues. Use when Codex needs to perform Ppt Orchestra Skill tasks, or when the user explicitly mentions ppt-orchestra-skill.'
---
