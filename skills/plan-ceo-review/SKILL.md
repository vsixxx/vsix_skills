...
description: CEO/founder-mode plan review. (gstack) Use when Codex needs to perform Plan Ceo Review tasks, or when the user explicitly mentions plan-ceo-review.
---
