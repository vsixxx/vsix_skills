...
description: SwiftUI architecture patterns, state management with @Observable, view composition, navigation, performance optimization, and modern iOS/macOS UI best practices. Use when Codex needs to perform Swiftui Patterns tasks, or when the user explicitly mentions swiftui-patterns.
---
