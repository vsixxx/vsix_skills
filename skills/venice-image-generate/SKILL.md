...
description: Image generation endpoints and available styles via the Venice.ai API. Use when Codex needs to perform Venice Image Generate tasks, or when the user explicitly mentions venice-image-generate.
---
