...
description: A neighborhood zine on the disappearing corner shops — portraits, voices, and what a block loses when they close. Built as a decision-grade story deck for community, local readers. Use when Codex needs to perform HTML Ppt Zhangzara Retro Zine tasks, or when the user explicitly mentions html-ppt-zhangzara-retro-zine.
---
