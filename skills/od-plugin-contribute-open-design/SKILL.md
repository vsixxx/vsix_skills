...
description: Open a pull request adding a local Open Design plugin to the Open Design community catalog using gh CLI. Use when Codex needs to perform Od Plugin Contribute Open Design tasks, or when the user explicitly mentions od-plugin-contribute-open-design.
---
