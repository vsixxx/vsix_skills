---
name: pokemon-player
description: Play Pokemon via headless emulator + RAM reads. Use when Codex needs to perform Pokemon Player tasks, or when the user explicitly mentions pokemon-player.
---
