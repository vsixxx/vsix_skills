---
name: ui-ux-pro-max
description: Catalog-only UI/UX Pro Max entry. The full upstream templates, data, and search workflow are not bundled in Open Design. Use when Codex needs to perform Ui Ux Pro Max tasks, or when the user explicitly mentions ui-ux-pro-max.
---
