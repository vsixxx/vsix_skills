...
description: 'A self-contained WebGL2 hero: thin-film interference over a crushed-foil surface whose palette shifts with the viewing angle; move the cursor to tilt the film. Use when Codex needs to perform Webgl Holographic Foil tasks, or when the user explicitly mentions webgl-holographic-foil.'
---
