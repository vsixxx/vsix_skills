...
description: 'TDD: enforce RED-GREEN-REFACTOR, tests before code. Use when Codex needs to perform Test Driven Development tasks, or when the user explicitly mentions test-driven-development.'
---
