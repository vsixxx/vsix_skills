...
When report mode calls for a substantive reusable or HTML artifact, produce a polished standalone HTML comps report following `../../plugin-support/shared/html-artifact-standard.md`. Keep peer selection, valuation evidence, and the premium or discount question central rather than forcing a standardized dashboard shell.
