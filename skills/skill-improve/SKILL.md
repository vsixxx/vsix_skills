---
name: skill-improve
description: Improve a skill using a test-fix-retest loop. Runs static checks, proposes targeted fixes, rewrites the skill, re-tests, and keeps or reverts based on score change. Use when Codex needs to perform Skill Improve tasks, or when the user explicitly mentions skill-improve.
---
