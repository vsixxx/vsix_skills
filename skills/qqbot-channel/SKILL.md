---
name: qqbot-channel
description: QQ channel management skill. Use qqbot_channel_api for explicit QQ channel-management requests; confirm write, delete, and bulk actions before calling authenticated QQ Open Platform endpoints. Use when Codex needs to perform Qqbot Channel tasks, or when the user explicitly mentions qqbot-channel.
---
