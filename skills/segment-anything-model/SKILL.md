...
description: 'SAM: zero-shot image segmentation via points, boxes, masks. Use when Codex needs to perform Segment Anything Model tasks, or when the user explicitly mentions segment-anything-model.'
---
