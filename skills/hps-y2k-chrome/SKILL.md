---
name: hps-y2k-chrome
description: 'Open Design''s KPI decision brief: activation and retention drivers, what''s working, and the one metric to move next. Built as a decision-grade data & finance deck for CRO, RevOps, leadership. Use when Codex needs to perform Hps Y2k Chrome tasks, or when the user explicitly mentions hps-y2k-chrome.'
---
