...
description: Run team-based orchestration for agent squads using work items, ownership, agent Kanban, merge gates, and control pane handoffs. Use when Codex needs to perform Team Agent Orchestration tasks, or when the user explicitly mentions team-agent-orchestration.
---
