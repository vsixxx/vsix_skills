...
description: 'Debug REST/GraphQL APIs: status codes, auth, schemas, repro. Use when Codex needs to perform Rest Graphql Debug tasks, or when the user explicitly mentions rest-graphql-debug.'
---
