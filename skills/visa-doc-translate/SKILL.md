...
description: Translate visa application documents (images) to English and create a bilingual PDF with original and translation Use when Codex needs to perform Visa Doc Translate tasks, or when the user explicitly mentions visa-doc-translate.
---
