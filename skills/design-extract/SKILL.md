---
name: design-extract
description: Extract design tokens (color / typography / spacing) from imported source code, screenshots, or Figma exports into the canonical token bag token-map consumes. Use when Codex needs to perform Design Extract tasks, or when the user explicitly mentions design-extract.
---
