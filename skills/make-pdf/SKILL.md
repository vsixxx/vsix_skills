---
name: make-pdf
description: Turn any markdown file into a publication-quality PDF. (gstack) Use when Codex needs to perform Make PDF tasks, or when the user explicitly mentions make-pdf.
---
