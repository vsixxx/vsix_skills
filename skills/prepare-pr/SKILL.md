---
name: prepare-pr
description: Prepare all work before creating a pull request, optionally for the issue provided as argument Use when Codex needs to perform Prepare PR tasks, or when the user explicitly mentions prepare-pr.
---
