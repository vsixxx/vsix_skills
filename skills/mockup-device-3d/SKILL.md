...
description: Static iPhone and MacBook 3D-style showcase with real HTML embedded on screens, glass-lens refraction, and 360-degree turntable composition. Use when Codex needs to perform Mockup Device 3d tasks, or when the user explicitly mentions mockup-device-3d.
---
