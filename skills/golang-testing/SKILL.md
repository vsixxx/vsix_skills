---
name: golang-testing
description: Go testing patterns including table-driven tests, subtests, benchmarks, fuzzing, and test coverage. Follows TDD methodology with idiomatic Go practices. Use when Codex needs to perform Golang Testing tasks, or when the user explicitly mentions golang-testing.
---
