---
name: discrawl
description: 'Discord archive: search, sync freshness, DMs, summaries, TUI, repo/release work. Use when Codex needs to perform Discrawl tasks, or when the user explicitly mentions discrawl.'
---
