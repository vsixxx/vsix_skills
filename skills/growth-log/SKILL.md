---
name: growth-log
description: Use after a complex task, failure, or when reviewing what was learned. Teaches how to write growth logs that extract reusable patterns — not diary entries. Use when Codex needs to perform Growth Log tasks, or when the user explicitly mentions growth-log.
---
