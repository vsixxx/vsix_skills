...
description: When/what to retrieve — open the brain page for a salient entity before answering from memory. Use when Codex needs to perform Retrieval Reflex tasks, or when the user explicitly mentions retrieval-reflex.
---
