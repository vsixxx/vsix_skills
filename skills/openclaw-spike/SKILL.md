---
name: openclaw-spike
description: Run throwaway prototypes to validate feasibility, compare approaches, and report a verdict. Use when Codex needs to perform Openclaw Spike tasks, or when the user explicitly mentions openclaw-spike.
---
