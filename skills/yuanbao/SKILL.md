---
name: yuanbao
description: 'Yuanbao (元宝) groups: @mention users, query info/members. Use when Codex needs to perform Yuanbao tasks, or when the user explicitly mentions yuanbao.'
---
