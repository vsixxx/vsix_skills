...
description: Push the run's accepted artifact to a downstream collaboration surface (cli, other code agents, cloud, desktop) and stamp the artifact manifest with the export target. Use when Codex needs to perform Open Design Handoff tasks, or when the user explicitly mentions open-design-handoff.
---
