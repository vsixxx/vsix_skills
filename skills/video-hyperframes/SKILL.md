...
description: Hyperframes / Remotion-compatible continuous frame animation with autoplay support. Use when Codex needs to perform Video Hyperframes tasks, or when the user explicitly mentions video-hyperframes.
---
