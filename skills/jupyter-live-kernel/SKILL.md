...
description: Iterative Python via live Jupyter kernel (hamelnb). Use when Codex needs to perform Jupyter Live Kernel tasks, or when the user explicitly mentions jupyter-live-kernel.
---
