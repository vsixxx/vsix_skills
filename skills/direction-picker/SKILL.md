...
description: 3-5 direction picker that lets the user choose before final generation. Use when Codex needs to perform Direction Picker tasks, or when the user explicitly mentions direction-picker.
---
