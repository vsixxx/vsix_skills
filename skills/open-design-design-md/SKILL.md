---
name: open-design-design-md
description: Create and manage DESIGN.md files. Useful for capturing design direction, tokens, and visual rules in a single source of truth. Use when Codex needs to perform Open Design Design Md tasks, or when the user explicitly mentions open-design-design-md.
---
