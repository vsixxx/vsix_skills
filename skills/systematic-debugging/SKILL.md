...
description: '4-phase root cause debugging: understand bugs before fixing. Use when Codex needs to perform Systematic Debugging tasks, or when the user explicitly mentions systematic-debugging.'
---
