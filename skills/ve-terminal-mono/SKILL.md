...
description: 'Open Design from the CLI: driving the full design workflow with the `od` command — scripted, composable, agent-ready. Built as a decision-grade AI literacy deck for developers, power users. Use when Codex needs to perform Ve Terminal Mono tasks, or when the user explicitly mentions ve-terminal-mono.'
---
