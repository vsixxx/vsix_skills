...
description: Regenerate OpenClaw release changelog sections from git history before beta or stable releases. Use when Codex needs to perform Openclaw Changelog Update tasks, or when the user explicitly mentions openclaw-changelog-update.
---
