---
name: od-default
description: Hidden fallback scenario for free-form Home prompts. Ask the task type first, then continue through the matching Open Design flow. Use when Codex needs to perform Od Default tasks, or when the user explicitly mentions od-default.
---
