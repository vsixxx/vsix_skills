...
description: EMR/EHR development patterns for healthcare applications. Clinical safety, encounter workflows, prescription generation, clinical decision support integration, and accessibility-first UI for medical data entry. Use when Codex needs to perform Healthcare Emr Patterns tasks, or when the user explicitly mentions healthcare-emr-patterns.
---
