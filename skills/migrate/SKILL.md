---
name: migrate
description: Universal migration from Obsidian, Notion, Logseq, markdown, CSV, JSON, Roam Use when Codex needs to perform Migrate tasks, or when the user explicitly mentions migrate.
---
