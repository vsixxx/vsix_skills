---
name: hermes-agent
description: Configure, extend, or contribute to Hermes Agent. Use when Codex needs to perform Hermes Agent tasks, or when the user explicitly mentions hermes-agent.
---
