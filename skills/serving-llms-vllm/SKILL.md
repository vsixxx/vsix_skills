...
description: 'vLLM: high-throughput LLM serving, OpenAI API, quantization. Use when Codex needs to perform Serving Llms Vllm tasks, or when the user explicitly mentions serving-llms-vllm.'
---
