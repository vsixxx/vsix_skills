...
description: 'Operate the Antigravity CLI (agy): plugins, auth, sandbox. Use when Codex needs to perform Antigravity CLI tasks, or when the user explicitly mentions antigravity-cli.'
---
