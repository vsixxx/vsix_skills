---
name: product-lens
description: Use this skill to validate the "why" before building, run product diagnostics, and pressure-test product direction before the request becomes an implementation contract. Use when Codex needs to perform Product Lens tasks, or when the user explicitly mentions product-lens.
---
