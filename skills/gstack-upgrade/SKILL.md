---
name: gstack-upgrade
description: Upgrade gstack to the latest version. Use when Codex needs to perform Gstack Upgrade tasks, or when the user explicitly mentions gstack-upgrade.
---
