---
name: llama-cpp
description: llama.cpp local GGUF inference + HF Hub model discovery. Use when Codex needs to perform Llama Cpp tasks, or when the user explicitly mentions llama-cpp.
---
