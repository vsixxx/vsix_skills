---
name: soul-audit
description: 6-phase interactive interview that generates the agent's identity (SOUL.md), user profile (USER.md), access control (ACCESS_POLICY.md), and operational cadence (HEARTBEAT.md). Re-runnable anytime to update any section. Use when Codex needs to perform Soul Audit tasks, or when the user explicitly mentions soul-audit.
---
