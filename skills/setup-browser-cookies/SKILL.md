...
description: Import cookies from your real Chromium browser into the headless browse session. (gstack) Use when Codex needs to perform Setup Browser Cookies tasks, or when the user explicitly mentions setup-browser-cookies.
---
