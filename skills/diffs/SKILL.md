---
name: diffs
description: Use the diffs tool to produce real, shareable diffs (viewer URL, file artifact, or both) instead of manual edit summaries. Use when Codex needs to perform Diffs tasks, or when the user explicitly mentions diffs.
---
