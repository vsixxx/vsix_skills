...
description: Convert PDFs, scanned documents, images, Word, PowerPoint, Excel, and web pages into Markdown, HTML, LaTeX, DOCX, or JSON with MinerU. Use for OCR, table and formula extraction, academic-paper parsing, batch document conversion, complex layouts, and multilingual document workflows. Prefer flash-extract for small token-free jobs and precision extract for large, high-fidelity, or multi-format jobs.
---
