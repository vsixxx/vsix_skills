...
description: Create, edit, audit, tidy, validate, or restructure AgentSkills and SKILL.md files. Use when Codex needs to perform Openclaw Skill Creator tasks, or when the user explicitly mentions openclaw-skill-creator.
---
