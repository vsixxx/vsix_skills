...
description: Library-agnostic Flutter/Dart code review checklist covering widget best practices, state management patterns (BLoC, Riverpod, Provider, GetX, MobX, Signals), Dart idioms, performance, accessibility, security, and clean architecture. Use when Codex needs to perform Flutter Dart Code Review tasks, or when the user explicitly mentions flutter-dart-code-review.
---
