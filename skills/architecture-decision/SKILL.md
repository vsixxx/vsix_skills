...
description: Creates an Architecture Decision Record (ADR) documenting a significant technical decision, its context, alternatives considered, and consequences. Every major technical choice should have an ADR. Use when Codex needs to perform Architecture Decision tasks, or when the user explicitly mentions architecture-decision.
---
