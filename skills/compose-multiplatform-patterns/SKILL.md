...
description: Compose Multiplatform and Jetpack Compose patterns for KMP projects — state management, navigation, theming, performance, and platform-specific UI. Use when Codex needs to perform Compose Multiplatform Patterns tasks, or when the user explicitly mentions compose-multiplatform-patterns.
---
