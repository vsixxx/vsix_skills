---
name: ux-review
description: Validates a UX spec, HUD design, or interaction pattern library for completeness, accessibility compliance, GDD alignment, and implementation readiness. Produces APPROVED / NEEDS REVISION / MAJOR REVISION NEEDED verdict with specific gaps. Use when Codex needs to perform Ux Review tasks, or when the user explicitly mentions ux-review.
---
