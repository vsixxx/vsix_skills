...
description: 'OpenClaw Tideclaw alpha/nightly release automation: isolated branches, local fixes, release CI, branch retention, and forward-port to main. Use when Codex needs to perform Release Openclaw Nightly tasks, or when the user explicitly mentions release-openclaw-nightly.'
---
