...
description: Use this plugin when the user wants a "Glitch Title Frame" HyperFrames motion video — Digital glitch, chromatic offset, and data-corruption title frame for video transitions or cyberpunk heroes. Use when Codex needs to perform Video Template Frame Glitch Title tasks, or when the user explicitly mentions video-template-frame-glitch-title.
---
