...
description: Use this skill when retrieving Jira tickets, analyzing requirements, updating ticket status, adding comments, or transitioning issues. Provides Jira API patterns via MCP or direct REST calls. Use when Codex needs to perform Jira Integration tasks, or when the user explicitly mentions jira-integration.
---
