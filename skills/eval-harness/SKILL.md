---
name: eval-harness
description: Formal evaluation framework for Claude Code sessions implementing eval-driven development (EDD) principles Use when Codex needs to perform Eval Harness tasks, or when the user explicitly mentions eval-harness.
---
