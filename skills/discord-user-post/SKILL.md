...
description: Post an approved message as the logged-in Discord user through the Discord desktop app. Use for release announcements or other direct user-authored Discord posts; not for OpenClaw channel sends, bots, webhooks, relays, agent sessions, or archive search. Use when Codex needs to perform Discord User Post tasks, or when the user explicitly mentions discord-user-post.
---
