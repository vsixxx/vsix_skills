---
name: feishu-perm
description: Feishu permission management for documents and files. Activate when user mentions sharing, permissions, collaborators. Use when Codex needs to perform Feishu Perm tasks, or when the user explicitly mentions feishu-perm.
---
