...
description: Best practices for writing Remotion React Markup Use when Codex needs to perform Remotion Markup tasks, or when the user explicitly mentions remotion-markup.
---
