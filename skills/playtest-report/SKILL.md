...
description: Generates a structured playtest report template or analyzes existing playtest notes into a structured format. Use this to standardize playtest feedback collection and analysis. Use when Codex needs to perform Playtest Report tasks, or when the user explicitly mentions playtest-report.
---
