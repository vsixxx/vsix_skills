...
Before recorded narration export, verify the external timing tool once:

```bash
command -v ffprobe || { echo "ffprobe is required for recorded narration export" >&2; exit 1; }
```
