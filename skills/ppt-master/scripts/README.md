...
| Image tools | `latex_render.py`, `analyze_images.py`, `image_search.py`, `slice_images.py` | [docs/image.md](./docs/image.md) |
...
- Prefer the unified entry points `project_manager.py` and `finalize_svg.py`; use the current agent's image tool for AI image generation
