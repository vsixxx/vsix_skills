...
Separate acquisition tool: instead of generating an image from a prompt, this
...
from image_sources.download import download_image  # noqa: E402
...
# rate), so the default concurrency is deliberately low. Three workers keep several
...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    if args.batch:
        ...
        try:
            ...
            return 130
        # A non-zero code flags rows that need attention. The owning workflow
        # decides whether the missing web asset blocks the confirmed design.
