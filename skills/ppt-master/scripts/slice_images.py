...
illustrations: ask the current agent's image tool for one multi-element sheet
(one call, one coherent style/palette), then cut the cells out here so each element is a
