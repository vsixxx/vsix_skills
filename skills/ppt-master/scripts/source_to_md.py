...
def dispatch_single(
    ...
    if conversion_type == "legacy_excel":
        print(
            "[ERROR] Legacy .xls files are archived but not converted automatically. "
            "Resave the workbook as .xlsx and run this command again.",
            file=sys.stderr,
        )
        return 1
