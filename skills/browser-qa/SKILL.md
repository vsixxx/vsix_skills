---
name: browser-qa
description: Use this skill to automate visual testing and UI interaction verification using browser automation after deploying features. Use when Codex needs to perform Browser Qa tasks, or when the user explicitly mentions browser-qa.
---
