...
description: Designer's eye plan review — interactive, like CEO and Eng review. (gstack) Use when Codex needs to perform Plan Design Review tasks, or when the user explicitly mentions plan-design-review.
---
