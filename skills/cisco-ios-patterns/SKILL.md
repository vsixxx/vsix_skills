...
description: Cisco IOS and IOS-XE review patterns for show commands, config hierarchy, wildcard masks, ACL placement, interface hygiene, and safe change-window verification. Use when Codex needs to perform Cisco Ios Patterns tasks, or when the user explicitly mentions cisco-ios-patterns.
---
