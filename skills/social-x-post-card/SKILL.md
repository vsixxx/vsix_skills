...
description: Realistic X post card with engagement metrics (likes, reposts, views), suited to video overlays or shareable image cards. Use when Codex needs to perform Social X Post Card tasks, or when the user explicitly mentions social-x-post-card.
---
