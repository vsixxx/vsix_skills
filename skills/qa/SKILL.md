---
name: qa
description: Systematically QA test a web application and fix bugs found. (gstack) Use when Codex needs to perform Qa tasks, or when the user explicitly mentions qa.
---
