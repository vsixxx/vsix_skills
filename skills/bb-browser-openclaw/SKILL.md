...
description: Turn any website into a CLI command. 36 platforms, 103 commands — Twitter, Reddit, GitHub, YouTube, Zhihu, Bilibili, Weibo, and more. Uses OpenClaw's browser directly, no extra extension needed. Use when Codex needs to perform Bb Browser Openclaw tasks, or when the user explicitly mentions bb-browser-openclaw.
---
