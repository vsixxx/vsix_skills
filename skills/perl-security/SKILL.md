---
name: perl-security
description: Comprehensive Perl security covering taint mode, input validation, safe process execution, DBI parameterized queries, web security (XSS/SQLi/CSRF), and perlcritic security policies. Use when Codex needs to perform Perl Security tasks, or when the user explicitly mentions perl-security.
---
