...
description: Spotify Now Playing-style card with album art, progress bar, and playback controls, suited to video overlays or personal homepages. Use when Codex needs to perform Social Spotify Card tasks, or when the user explicitly mentions social-spotify-card.
---
