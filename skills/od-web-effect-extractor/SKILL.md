...
description: Extract visual effects, animation systems, Canvas/WebGL/Shader behavior, and interaction details from a reference website, then rebuild them as an editable Open Design web artifact. Use when Codex needs to perform Od Web Effect Extractor tasks, or when the user explicitly mentions od-web-effect-extractor.
---
