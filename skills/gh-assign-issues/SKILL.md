...
description: Use to assign GitHub issues to a milestone and/or owners in bulk, verifying each. Use when Codex needs to perform Gh Assign Issues tasks, or when the user explicitly mentions gh-assign-issues.
---
