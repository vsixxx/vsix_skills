---
name: shopify
description: Shopify Admin & Storefront GraphQL APIs via curl. Products, orders, customers, inventory, metafields. Use when Codex needs to perform Shopify tasks, or when the user explicitly mentions shopify.
---
