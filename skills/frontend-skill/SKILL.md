---
name: frontend-skill
description: Create visually strong landing pages, websites, and app UIs with restrained composition. OpenAI's production frontend playbook. Use when Codex needs to perform Frontend Skill tasks, or when the user explicitly mentions frontend-skill.
---
