---
name: obsidian
description: Read, search, create, and edit notes in the Obsidian vault. Use when Codex needs to perform Obsidian tasks, or when the user explicitly mentions obsidian.
---
...
The documented vault-path convention is the `OBSIDIAN_VAULT_PATH` environment variable, for example from `a local `.env` file or shell environment`. If it is unset, use `~/Documents/Obsidian Vault`.
