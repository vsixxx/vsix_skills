...
description: 'Open Design live demo: from a one-line prompt to runnable design in a single session — the flow, live. Built as a decision-grade AI literacy deck for developers, prospects, community. Use when Codex needs to perform HTML Ppt Presenter Mode tasks, or when the user explicitly mentions html-ppt-presenter-mode.'
---
