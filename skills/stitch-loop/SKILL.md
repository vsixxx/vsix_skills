---
name: stitch-loop
description: Iterative design-to-code feedback loop. Critique → adjust → ship cycle for tightening visual fidelity between brief and built UI. Use when Codex needs to perform Stitch Loop tasks, or when the user explicitly mentions stitch-loop.
---
