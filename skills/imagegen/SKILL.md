---
name: imagegen
description: Generate and edit images using OpenAI's Image API for project assets — UI mockups, icons, illustrations, social cards, and visual references. Use when Codex needs to perform Imagegen tasks, or when the user explicitly mentions imagegen.
---
