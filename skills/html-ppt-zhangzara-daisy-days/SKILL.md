...
description: A customer-success workshop onboarding users to a project-management app — the first-value path and the habits that retain. Built as a decision-grade professional training deck for new customers, CS team. Use when Codex needs to perform HTML Ppt Zhangzara Daisy Days tasks, or when the user explicitly mentions html-ppt-zhangzara-daisy-days.
---
