---
name: sora
description: Generate, remix, and manage short video clips via OpenAI's Sora API. Useful for cinematic shots, b-roll, and rapid concept video iteration. Use when Codex needs to perform Sora tasks, or when the user explicitly mentions sora.
---
