...
- If an iteration introduced a reusable preference, apply `skills/codexpp-sales-user-context/references/plugin-memory.md`: narrow, low-risk accepted preferences can be summarized and saved automatically; broad, sensitive, ambiguous, or high-risk preferences require explicit save approval.
