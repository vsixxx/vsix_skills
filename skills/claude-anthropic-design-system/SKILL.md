...
description: Use this Claude / Anthropic style design system for warm, restrained, editorial AI workbench interfaces. Use when Codex needs to perform Claude Anthropic Design System tasks, or when the user explicitly mentions claude-anthropic-design-system.
---
