---
name: shot
description: PUA Shot — compact all-in-one PUA reference for explicit injection into sub-agents or short sessions. Strong flavor, same evidence-first behavior. Use when Codex needs to perform Shot tasks, or when the user explicitly mentions shot.
---
