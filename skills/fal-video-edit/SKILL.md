---
name: fal-video-edit
description: Edit existing videos using AI — remix style, upscale, remove background, and add audio via fal.ai's hosted video models. Use when Codex needs to perform Fal Video Edit tasks, or when the user explicitly mentions fal-video-edit.
---
