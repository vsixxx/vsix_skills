...
description: Django security best practices, authentication, authorization, CSRF protection, SQL injection prevention, XSS prevention, and secure deployment configurations. Use when Codex needs to perform Django Security tasks, or when the user explicitly mentions django-security.
---
