...
description: Hunt for exploitable, bounty-worthy security issues in repositories. Focuses on remotely reachable vulnerabilities that qualify for real reports instead of noisy local-only findings. Use when Codex needs to perform Security Bounty Hunter tasks, or when the user explicitly mentions security-bounty-hunter.
---
