...
description: An economics senior thesis on the employment effects of local minimum-wage increases — identification strategy, evidence, and limitations. Built as a decision-grade coursework defense deck for thesis committee. Use when Codex needs to perform HTML Ppt Zhangzara Cartesian tasks, or when the user explicitly mentions html-ppt-zhangzara-cartesian.
---
