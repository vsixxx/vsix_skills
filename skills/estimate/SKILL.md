---
name: estimate
description: Estimates task effort by analyzing complexity, dependencies, historical velocity, and risk factors. Produces a structured estimate with confidence levels. Use when Codex needs to perform Estimate tasks, or when the user explicitly mentions estimate.
---
