...
description: NYT-newsroom typography, staggered reveal animation, and editorial-grade charts (line, bar, or range band). Use when Codex needs to perform Frame Data Chart Nyt tasks, or when the user explicitly mentions frame-data-chart-nyt.
---
