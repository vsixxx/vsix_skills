...
description: Triage, redact, clean up, and resolve OpenClaw GitHub Secret Scanning alerts in issues or PRs. Use when Codex needs to perform Openclaw Secret Scanning Maintainer tasks, or when the user explicitly mentions openclaw-secret-scanning-maintainer.
---
