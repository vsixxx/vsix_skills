---
name: unbroker
description: Autonomously remove your info from data-broker sites. Use when Codex needs to perform Unbroker tasks, or when the user explicitly mentions unbroker.
---
