---
name: pixel-art
description: Pixel art w/ era palettes (NES, Game Boy, PICO-8). Use when Codex needs to perform Pixel Art tasks, or when the user explicitly mentions pixel-art.
---
...
- ffmpeg on PATH (only needed for video output)
