---
name: autoplan
description: Auto-review pipeline — reads the full CEO, design, eng, and DX review skills from disk and runs them sequentially with auto-decisions using 6 decision principles. (gstack) Use when Codex needs to perform Autoplan tasks, or when the user explicitly mentions autoplan.
---
